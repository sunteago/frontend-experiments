 ...
 */ const Es = "158",
  zn = { LEFT: 0, MIDDLE: 1, RIGHT: 2, ROTATE: 0, DOLLY: 1, PAN: 2 },
  Hn = { ROTATE: 0, PAN: 1, DOLLY_PAN: 2, DOLLY_ROTATE: 3 },
  El = 0,
  Xs = 1,
  yl = 2,
  Eo = 1,
...
const Ra = new Oe().set(
  ...
  Xe = {
    ...
    convert: function (i, e, t) {
      ...
      const n = Gi[e].toReference,
        r = Gi[t].fromReference;
      return r(n(i));
    },
...
class Et extends Fn {
  ...
  get encoding() {
    return (
      bi("THREE.Texture: Property .encoding has been replaced by .colorSpace."),
      this.colorSpace === We ? Dn : Do
    );
  }
  set encoding(e) {
    bi("THREE.Texture: Property .encoding has been replaced by .colorSpace."),
      (this.colorSpace = e === Dn ? We : Dt);
  }
}
Et.DEFAULT_IMAGE = null;
Et.DEFAULT_MAPPING = bo;
      ...
      return (
        S > T && S > A
          ? S < 0.01
            ...
            : ((n = Math.sqrt(S)), (r = C / n), (s = w / n))
          : T > A
          ? T < 0.01
            ? ((n = 0.707106781), (r = 0), (s = 0.707106781))
            : ((r = Math.sqrt(T)), (n = C / r), (s = V / r))
          : A < 0.01
          ? ((n = 0.707106781), (r = 0.707106781), (s = 0))
          : ((s = Math.sqrt(A)), (n = w / s), (r = V / s)),
        this.set(n, r, s, t),
        this
      );
    }
...
class Hc extends Fn {
  constructor(e = 1, t = 1, n = {}) {
    ...
    n.encoding !== void 0 &&
      ...
      (n.colorSpace = n.encoding === Dn ? We : Dt)),
      (n = Object.assign(
        {
          generateMipmaps: !1,
          internalFormat: null,
  ...
  static slerpFlat(e, t, n, r, s, o, a) {
    ...
    if (d !== _ || l !== f || c !== m || u !== v) {
      ...
      if (S > Number.EPSILON) {
        const A = Math.sqrt(S),
          C = Math.atan2(A, h * E);
        (p = Math.sin(p * C) / A), (a = Math.sin(a * C) / A);
      }
      const T = a * E;
      if (
        ((l = l * p + f * T),
...
class Pi {
    ...
    if (n !== void 0) {
      ...
      if (t === !0 && s !== void 0 && e.isInstancedMesh !== !0)
        for (let o = 0, a = s.count; o < a; o++)
          e.isMesh === !0
            ? e.getVertexPosition(o, It)
            : It.fromBufferAttribute(s, o),
            It.applyMatrix4(e.matrixWorld),
            this.expandByPoint(It);
      else
        e.boundingBox !== void 0
          ? (e.boundingBox === null && e.computeBoundingBox(),
            Vi.copy(e.boundingBox))
          : (n.boundingBox === null && n.computeBoundingBox(),
            Vi.copy(n.boundingBox)),
  ...
  intersectsSphere(e) {
    return (
      this.clampPoint(e.center, It),
      It.distanceToSquared(e.center) <= e.radius * e.radius
    );
  }
  intersectsPlane(e) {
    let t, n;
  ...
  intersectsTriangle(e) {
    ...
    this.getCenter(_i),
      ki.subVectors(this.max, _i),
      kn.subVectors(e.a, _i),
      Wn.subVectors(e.b, _i),
      Xn.subVectors(e.c, _i),
      rn.subVectors(Wn, kn),
      sn.subVectors(Xn, Wn),
      yn.subVectors(kn, Xn);
    let t = [
    ...
    return !Wr(t, kn, Wn, Xn, ki) ||
      ((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !Wr(t, kn, Wn, Xn, ki))
      ? !1
      : (Wi.crossVectors(rn, sn),
        (t = [Wi.x, Wi.y, Wi.z]),
        Wr(t, kn, Wn, Xn, ki));
  }
  clampPoint(e, t) {
    ...
    return (
      this.isEmpty()
        ...
        : (this.getCenter(e.center),
          (e.radius = this.getSize(It).length() * 0.5)),
      e
    );
  }
  intersect(e) {
  ...
  union(e) {
    return e.isEmpty()
      ...
      : (this.center.equals(e.center) === !0
          ...
          : (Xr.subVectors(e.center, this.center).setLength(e.radius),
            this.expandByPoint(vi.copy(e.center).add(Xr)),
            this.expandByPoint(vi.copy(e.center).sub(Xr))),
        this);
  }
  equals(e) {
...
class Bo {
  ...
  distanceSqToPoint(e) {
    ...
    return t < 0
      ...
      : ($t.copy(this.origin).addScaledVector(this.direction, t),
        $t.distanceToSquared(e));
  }
  distanceSqToSegment(e, t, n, r) {
    Yr.copy(e).add(t).multiplyScalar(0.5),
      Xi.copy(t).sub(e).normalize(),
      an.copy(this.origin).sub(Yr);
    const s = e.distanceTo(t) * 0.5,
      o = -this.direction.dot(Xi),
    ...
    return (
      ...
      r && r.copy(Yr).addScaledVector(Xi, f),
      m
    );
  }
  intersectSphere(e, t) {
  ...
  intersectTriangle(e, t, n, r, s) {
    qr.subVectors(t, e), Yi.subVectors(n, e), $r.crossVectors(qr, Yi);
    let o = this.direction.dot($r),
      a;
    if (o > 0) {
      if (r) return null;
      a = 1;
    ...
    const l = a * this.direction.dot(Yi.crossVectors(an, Yi));
    if (l < 0) return null;
    const c = a * this.direction.dot(qr.cross(an));
...
class it {
  ...
  extractRotation(e) {
    const t = this.elements,
      n = e.elements,
      r = 1 / Yn.setFromMatrixColumn(e, 0).length(),
      s = 1 / Yn.setFromMatrixColumn(e, 1).length(),
  ...
  multiplyMatrices(e, t) {
    const n = e.elements,
      ...
      U = r[15];
    return (
      (s[0] = o * C + a * b + l * P + c * ie),
      (s[4] = o * w + a * W + l * z + c * Z),
      (s[8] = o * V + a * X + l * q + c * j),
      (s[12] = o * M + a * K + l * Y + c * U),
      (s[1] = u * C + d * b + f * P + m * ie),
      (s[5] = u * w + d * W + f * z + m * Z),
      (s[9] = u * V + d * X + f * q + m * j),
      (s[13] = u * M + d * K + f * Y + m * U),
      (s[2] = v * C + _ * b + p * P + h * ie),
      (s[6] = v * w + _ * W + p * z + h * Z),
      (s[10] = v * V + _ * X + p * q + h * j),
      (s[14] = v * M + _ * K + p * Y + h * U),
      (s[3] = E * C + S * b + T * P + A * ie),
      (s[7] = E * w + S * W + T * z + A * Z),
      (s[11] = E * V + S * X + T * q + A * j),
      (s[15] = E * M + S * K + T * Y + A * U),
      this
    );
  }
  multiplyScalar(e) {
  ...
  invert() {
    const e = this.elements,
      ...
      p = e[14],
      h = e[15],
      E = d * p * c - _ * f * c + _ * l * m - a * p * m - d * l * h + a * f * h,
      S = v * f * c - u * p * c - v * l * m + o * p * m + u * l * h - o * f * h,
      T = u * _ * c - v * d * c + v * a * m - o * _ * m - u * a * h + o * d * h,
      A = v * d * l - u * _ * l - v * a * f + o * _ * f + u * a * p - o * d * p,
      C = t * E + n * S + r * T + s * A;
    if (C === 0)
  ...
  makePerspective(e, t, n, r, s, o, a = en) {
    const l = this.elements,
      ...
      f = (n + r) / (n - r);
    let m, v;
    if (a === en) (m = -(o + s) / (o - s)), (v = (-2 * o * s) / (o - s));
    else if (a === mr) (m = -o / (o - s)), (v = (-o * s) / (o - s));
    else
      throw new Error(
  ...
  makeOrthographic(e, t, n, r, s, o, a = en) {
    const l = this.elements,
      c = 1 / (t - e),
      u = 1 / (n - r),
      d = 1 / (o - s),
      ...
      m = (n + r) * u;
    let v, _;
    if (a === en) (v = (o + s) * d), (_ = -2 * d);
    else if (a === mr) (v = s * d), (_ = -1 * d);
    else
      throw new Error(
...
const Yn = new D(),
  ...
  Da = new In();
class xr {
  constructor(e = 0, t = 0, n = 0, r = xr.DEFAULT_ORDER) {
    (this.isEuler = !0),
      (this._x = e),
      (this._y = t),
      (this._z = n),
  ...
  setFromQuaternion(e, t, n) {
    return (
      Pa.makeRotationFromQuaternion(e), this.setFromRotationMatrix(Pa, t, n)
    );
  }
...
class pt extends Fn {
  ...
  worldToLocal(e) {
    return (
      ...
      e.applyMatrix4(jt.copy(this.matrixWorld).invert())
    );
  }
  lookAt(e, t, n) {
    ...
    this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight
        ? jt.lookAt(xi, $i, this.up)
        : jt.lookAt($i, xi, this.up),
      this.quaternion.setFromRotationMatrix(jt),
      r &&
        (jt.extractRotation(r.matrixWorld),
        qn.setFromRotationMatrix(jt),
  ...
  attach(e) {
    return (
      ...
      e.parent !== null &&
        (e.parent.updateWorldMatrix(!0, !1), jt.multiply(e.parent.matrixWorld)),
      e.applyMatrix4(jt),
      this.add(e),
  ...
  getWorldQuaternion(e) {
    return (
      this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(xi, e, Yc), e
    );
  }
  getWorldScale(e) {
    return (
      this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(xi, qc, e), e
    );
  }
  getWorldDirection(e) {
    this.updateWorldMatrix(!0, !1);
...
class Ot {
  ...
  static getBarycoord(e, t, n, r, s) {
    Ft.subVectors(r, t), Kt.subVectors(n, t), jr.subVectors(e, t);
    const o = Ft.dot(Ft),
      a = Ft.dot(Kt),
      l = Ft.dot(jr),
      c = Kt.dot(Kt),
  ...
  getUV(e, t, n, r, s) {
    return (
      ji === !1 &&
        ...
        (ji = !0)),
      Ot.getInterpolation(e, this.a, this.b, this.c, t, n, r, s)
    );
  }
  ...
  closestPointToPoint(e, t) {
    const n = this.a,
      ...
      s = this.c;
    let o, a;
    $n.subVectors(r, n), jn.subVectors(s, n), Kr.subVectors(e, n);
    const l = $n.dot(Kr),
      c = jn.dot(Kr);
    ...
    const f = l * d - u * c;
    if (f <= 0 && l >= 0 && u <= 0)
      return (o = l / (l - u)), t.copy(n).addScaledVector($n, o);
    Jr.subVectors(e, s);
    const m = $n.dot(Jr),
      v = jn.dot(Jr);
    ...
    const _ = m * c - l * v;
    if (_ <= 0 && c >= 0 && v <= 0)
      return (a = c / (c - v)), t.copy(n).addScaledVector(jn, a);
    const p = u * v - m * d;
    if (p <= 0 && d - u >= 0 && m - v >= 0)
      return (
        Oa.subVectors(s, r),
    ...
    return (
      (o = _ * h),
      (a = f * h),
      t.copy(n).addScaledVector($n, o).addScaledVector(jn, a)
    );
  }
  equals(e) {
...
class ke {
  ...
  setHSL(e, t, n, r = Xe.workingColorSpace) {
    if (((e = bs(e, 1)), (t = ft(t, 0, 1)), (n = ft(n, 0, 1)), t === 0))
  ...
  getHex(e = We) {
    return (
      Xe.fromWorkingColorSpace(dt.copy(this), e),
      Math.round(ft(dt.r * 255, 0, 255)) * 65536 +
        Math.round(ft(dt.g * 255, 0, 255)) * 256 +
        Math.round(ft(dt.b * 255, 0, 255))
    );
  }
  getHexString(e = We) {
  ...
  getHSL(e, t = Xe.workingColorSpace) {
    Xe.fromWorkingColorSpace(dt.copy(this), t);
    const n = dt.r,
      r = dt.g,
      s = dt.b,
      o = Math.max(n, r, s),
  ...
  lerpHSL(e, t) {
    this.getHSL(ln), e.getHSL(Ki);
    const n = Ti(ln.h, Ki.h, t),
      r = Ti(ln.s, Ki.s, t),
      s = Ti(ln.l, Ki.l, t);
...
class Di extends Fn {
  constructor() {
    super(),
      (this.isMaterial = !0),
      Object.defineProperty(this, "id", { value: Kc++ }),
      (this.uuid = di()),
      (this.name = ""),
      (this.type = "Material"),
      (this.blending = ai),
  ...
  toJSON(e) {
    ...
    (n.uuid = this.uuid),
      ...
      this.side !== vn && (n.side = this.side),
      this.vertexColors === !0 && (n.vertexColors = !0),
      this.opacity < 1 && (n.opacity = this.opacity),
      this.transparent === !0 && (n.transparent = !0),
      this.blendSrc !== fs && (n.blendSrc = this.blendSrc),
      this.blendDst !== ps && (n.blendDst = this.blendDst),
      this.blendEquation !== Rn && (n.blendEquation = this.blendEquation),
      ...
      this.depthFunc !== ur && (n.depthFunc = this.depthFunc),
...
class Wt {
  ...
  setComponent(e, t, n) {
    return (
      this.normalized && (n = _t(n, this.array)),
...
class nn extends Fn {
  ...
  computeBoundingBox() {
    ...
    if (e !== void 0) {
      if ((this.boundingBox.setFromBufferAttribute(e), t))
        for (let n = 0, r = t.length; n < r; n++) {
          const s = t[n];
          At.setFromBufferAttribute(s),
            this.morphTargetsRelative
              ? (lt.addVectors(this.boundingBox.min, At.min),
                this.boundingBox.expandByPoint(lt),
                lt.addVectors(this.boundingBox.max, At.max),
                this.boundingBox.expandByPoint(lt))
    ...
    if (e) {
      ...
      if ((At.setFromBufferAttribute(e), t))
        for (let s = 0, o = t.length; s < o; s++) {
          const a = t[s];
          Mi.setFromBufferAttribute(a),
            this.morphTargetsRelative
              ? (lt.addVectors(At.min, Mi.min),
                At.expandByPoint(lt),
        ...
        for (let s = 0, o = t.length; s < o; s++) {
          ...
          for (let c = 0, u = a.count; c < u; c++)
            lt.fromBufferAttribute(a, c),
              l && (Kn.fromBufferAttribute(e, c), lt.add(Kn)),
              (r = Math.max(r, n.distanceToSquared(lt)));
        }
  ...
  computeTangents() {
    ...
    const l = this.getAttribute("tangent").array,
      c = [],
      u = [];
    for (let b = 0; b < a; b++) (c[b] = new D()), (u[b] = new D());
    const d = new D(),
      f = new D(),
      m = new D(),
      v = new Ce(),
    ...
    for (let b = 0, W = T.length; b < W; ++b) {
      const X = T[b],
        K = X.start,
        P = X.count;
      for (let z = K, q = K + P; z < q; z += 3) S(n[z + 0], n[z + 1], n[z + 2]);
    }
    const A = new D(),
      C = new D(),
      w = new D(),
      V = new D();
    function M(b) {
      w.fromArray(s, b * 3), V.copy(w);
      const W = c[b];
      A.copy(W),
        A.sub(w.multiplyScalar(w.dot(W))).normalize(),
        C.crossVectors(V, W);
      const K = C.dot(u[b]) < 0 ? -1 : 1;
      (l[b * 4] = A.x),
        (l[b * 4 + 1] = A.y),
        (l[b * 4 + 2] = A.z),
        (l[b * 4 + 3] = K);
...
class ct extends pt {
    ...
    if (s && a) {
      ...
      for (let l = 0, c = s.length; l < c; l++) {
        const u = a[l],
          d = s[l];
        u !== 0 &&
          (ts.fromBufferAttribute(d, e),
          o ? Qi.addScaledVector(ts, u) : Qi.addScaledVector(ts.sub(t), u));
      }
      t.add(Qi);
    }
    return t;
  ...
  raycast(e, t) {
    ...
    r !== void 0 &&
      ...
      !(
        Ji.containsPoint(bn.origin) === !1 &&
        (bn.intersectSphere(Ji, za) === null ||
          bn.origin.distanceToSquared(za) > (e.far - e.near) ** 2)
      ) &&
        (Ba.copy(s).invert(),
        bn.copy(e.ray).applyMatrix4(Ba),
    ...
    if (a !== null)
      if (Array.isArray(o))
        for (let v = 0, _ = f.length; v < _; v++) {
          ...
          for (let T = E, A = S; T < A; T += 3) {
            const C = a.getX(T),
              w = a.getX(T + 1),
              V = a.getX(T + 2);
            (r = sr(this, h, e, n, c, u, d, C, w, V)),
              r &&
...
function Jc(i, e, t, n, r, s, o, a) {
  let l;
  if (
    (e.side === St
      ? (l = n.intersectTriangle(o, s, r, !0, a))
      : (l = n.intersectTriangle(r, s, o, e.side === vn, a)),
    l === null)
  )
    return null;
  ...
  return c < t.near || c > t.far
    ? null
    : { distance: c, point: rr.clone(), object: i };
}
function sr(i, e, t, n, r, s, o, a, l, c) {
  i.getVertexPosition(a, Zn),
    i.getVertexPosition(l, Jn),
    i.getVertexPosition(c, Qn);
  const u = Jc(i, e, t, n, Zn, Jn, Qn, ir);
  if (u) {
    r &&
      (er.fromBufferAttribute(r, a),
      tr.fromBufferAttribute(r, l),
      nr.fromBufferAttribute(r, c),
      (u.uv = Ot.getInterpolation(ir, Zn, Jn, Qn, er, tr, nr, new Ce()))),
      s &&
        (er.fromBufferAttribute(s, a),
        tr.fromBufferAttribute(s, l),
        nr.fromBufferAttribute(s, c),
        (u.uv1 = Ot.getInterpolation(ir, Zn, Jn, Qn, er, tr, nr, new Ce())),
        (u.uv2 = u.uv1)),
      o &&
        (Ha.fromBufferAttribute(o, a),
        Ga.fromBufferAttribute(o, l),
        Va.fromBufferAttribute(o, c),
        (u.normal = Ot.getInterpolation(ir, Zn, Jn, Qn, Ha, Ga, Va, new D())),
        u.normal.dot(n.direction) > 0 && u.normal.multiplyScalar(-1));
    const d = { a, b: l, c, normal: new D(), materialIndex: 0 };
    Ot.getNormal(Zn, Jn, Qn, d.normal), (u.face = d);
  }
  return u;
}
class On extends nn {
  constructor(e = 1, t = 1, n = 1, r = 1, s = 1, o = 1) {
    ...
    function v(_, p, h, E, S, T, A, C, w, V, M) {
      const b = T / w,
        W = A / V,
        X = T / 2,
        K = A / 2,
      ...
      for (let j = 0; j < V; j++)
        for (let U = 0; U < w; U++) {
          const G = f + U + z * j,
            ...
            he = f + (U + 1) + z * (j + 1),
            fe = f + (U + 1) + z * j;
          l.push(G, ce, fe), l.push(ce, he, fe), (ie += 6);
        }
      a.addGroup(m, ie, M), (m += ie), (f += Y);
    }
  }
  copy(e) {
    return (
...
class Nn extends Di {
  ...
  copy(e) {
    return (
      ...
      (this.uniformsGroups = Qc(e.uniformsGroups)),
...
class wt extends Xo {
  ...
  getEffectiveFOV() {
    return Ri * 2 * Math.atan(Math.tan(yi * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
...
class ih extends pt {
  constructor(e, t, n) {
    ...
    const r = new wt(ei, ti, e, t);
    (r.layers = this.layers), this.add(r);
    const s = new wt(ei, ti, e, t);
    (s.layers = this.layers), this.add(s);
    const o = new wt(ei, ti, e, t);
    (o.layers = this.layers), this.add(o);
    const a = new wt(ei, ti, e, t);
    (a.layers = this.layers), this.add(a);
    const l = new wt(ei, ti, e, t);
    (l.layers = this.layers), this.add(l);
    const c = new wt(ei, ti, e, t);
...
class rh extends Un {
  constructor(e = 1, t = {}) {
    ...
    t.encoding !== void 0 &&
      ...
      (t.colorSpace = t.encoding === Dn ? We : Dt)),
      (this.texture = new Yo(
        r,
        t.mapping,
        t.wrapS,
  ...
  fromEquirectangularTexture(e, t) {
    ...
    const o = new ct(r, s),
      a = t.minFilter;
    return (
      t.minFilter === Ai && (t.minFilter = Pt),
      new ih(1, 10, this).update(e, o),
      (t.minFilter = a),
      o.geometry.dispose(),
      o.material.dispose(),
      this
...
class cn {
  ...
  setFromCoplanarPoints(e, t, n) {
    const r = ns.subVectors(n, t).cross(sh.subVectors(e, t)).normalize();
  ...
  applyMatrix4(e, t) {
    const n = t || ah.getNormalMatrix(e),
      r = this.coplanarPoint(ns).applyMatrix4(e),
...
class ws {
  ...
  setFromProjectionMatrix(e, t = en) {
    ...
    if (
      ...
      n[2].setComponents(l + o, f + u, p + v, T + E).normalize(),
      n[3].setComponents(l - o, f - u, p - v, T - E).normalize(),
      n[4].setComponents(l - a, f - d, p - _, T - S).normalize(),
      t === en)
    )
      n[5].setComponents(l + a, f + d, p + _, T + S).normalize();
    else if (t === mr) n[5].setComponents(a, d, _, S).normalize();
    else
      throw new Error(
  ...
  intersectsObject(e) {
    if (e.boundingSphere !== void 0)
      e.boundingSphere === null && e.computeBoundingSphere(),
        An.copy(e.boundingSphere).applyMatrix4(e.matrixWorld);
    else {
      const t = e.geometry;
  ...
  intersectsSprite(e) {
    return (
      An.center.set(0, 0, 0),
      (An.radius = 0.7071067811865476),
      An.applyMatrix4(e.matrixWorld),
      this.intersectsSphere(An)
    );
  }
  intersectsSphere(e) {
    const t = this.planes,
  ...
  intersectsBox(e) {
    ...
    for (let n = 0; n < 6; n++) {
      const r = t[n];
      if (
        ((ar.x = r.normal.x > 0 ? e.max.x : e.min.x),
        (ar.y = r.normal.y > 0 ? e.max.y : e.min.y),
        (ar.z = r.normal.z > 0 ? e.max.z : e.min.z),
...
class Ui extends nn {
  constructor(e = 1, t = 1, n = 1, r = 1) {
    ...
    for (let h = 0; h < u; h++) {
      ...
      for (let S = 0; S < c; S++) {
        const T = S * d - s;
        v.push(T, -E, 0), _.push(0, 0, 1), p.push(S / a), p.push(1 - h / l);
      }
    }
    for (let h = 0; h < l; h++)
      for (let E = 0; E < a; E++) {
        const S = E + c * h,
          ...
          A = E + 1 + c * (h + 1),
          C = E + 1 + c * h;
        m.push(S, T, C), m.push(T, A, C);
      }
    this.setIndex(m),
      this.setAttribute("position", new Rt(v, 3)),
      this.setAttribute("normal", new Rt(_, 3)),
      this.setAttribute("uv", new Rt(p, 2));
  }
  copy(e) {
    return (
      super.copy(e), (this.parameters = Object.assign({}, e.parameters)), this
...
#endif`,
  vh = `float G_BlinnPhong_Implicit( ) {
	return 0.25;
}
...
#endif`,
  Fh = "gl_FragColor = linearToOutputTexel( gl_FragColor );",
  Oh = `
...
#define RE_IndirectDiffuse		RE_IndirectDiffuse_Toon`,
  nu = `BlinnPhongMaterial material;
material.diffuseColor = diffuseColor.rgb;
material.specularColor = specular;
material.specularShininess = shininess;
material.specularStrength = specularStrength;`,
  iu = `varying vec3 vViewPosition;
...
#endif`,
  vu = `#ifdef USE_METALNESSMAP
	uniform sampler2D metalnessMap;
#endif`,
  xu = `#if defined( USE_MORPHCOLORS ) && defined( MORPHTARGETS_TEXTURE )
...
gl_Position = projectionMatrix * mvPosition;`,
  ...
  Vu = `#if NUM_SPOT_LIGHT_COORDS > 0
	...
	#endif
#endif`,
  ku = `#if ( defined( USE_SHADOWMAP ) && ( NUM_DIR_LIGHT_SHADOWS > 0 || NUM_POINT_LIGHT_SHADOWS > 0 ) ) || ( NUM_SPOT_LIGHT_COORDS > 0 )
...
#endif`,
  rd = `#if defined( USE_ENVMAP ) || defined( DISTANCE ) || defined ( USE_SHADOWMAP ) || defined ( USE_TRANSMISSION ) || NUM_SPOT_LIGHT_COORDS > 0
...
void main() {
  ...
  Ne = {
    ...
    clipping_planes_pars_vertex: yh,
  ...
  Vt = {
    ...
    depth: {
      uniforms: vt([oe.common, oe.displacementmap]),
...
function zd(i, e, t, n, r, s, o) {
  ...
  function v(p, h) {
    ...
    S && S.isTexture && (S = (h.backgroundBlurriness > 0 ? t : e).get(S)),
      S === null ? _(a, l) : S && S.isColor && (_(S, 1), (E = !0));
    ...
    T === "additive"
      ...
      S && (S.isCubeTexture || S.mapping === _r)
        ? (u === void 0 &&
            ((u = new ct(
              new On(1, 1, 1),
              new Nn({
                name: "BackgroundCubeMaterial",
                uniforms: ui(Vt.backgroundCube.uniforms),
            ...
            (u.onBeforeRender = function (A, C, w) {
          ...
          (u.material.toneMapped = Xe.getTransfer(S.colorSpace) !== $e),
        ...
        : S &&
          ...
          (c === void 0 &&
            ((c = new ct(
              ...
              new Nn({
                ...
                uniforms: ui(Vt.background.uniforms),
          ...
          (c.material.uniforms.backgroundIntensity.value =
            h.backgroundIntensity),
          (c.material.toneMapped = Xe.getTransfer(S.colorSpace) !== $e),
  ...
  function _(p, h) {
    p.getRGB(or, Wo(i)), n.buffers.color.setClear(or.r, or.g, or.b, h, o);
  }
  return {
...
function Hd(i, e, t, n) {
  ...
  function d(P, z, q, Y, ie) {
    ...
    if (o) {
      ...
      (c.geometry !== Y.id || c.program !== q.id || c.wireframe !== j) &&
        ((c.geometry = Y.id), (c.program = q.id), (c.wireframe = j), (Z = !0));
    }
  ...
  function _(P, z, q) {
    ...
    let ie = a[P.id];
    ie === void 0 && ((ie = {}), (a[P.id] = ie));
    let Z = ie[z.id];
    Z === void 0 && ((Z = {}), (ie[z.id] = Z));
    let j = Z[Y];
    return j === void 0 && ((j = p(f())), (Z[Y] = j)), j;
  }
  function p(P) {
    const z = [],
      q = [],
      Y = [];
    for (let ie = 0; ie < r; ie++) (z[ie] = 0), (q[ie] = 0), (Y[ie] = 0);
    return {
      geometry: null,
      program: null,
      wireframe: !1,
        ...
        if (
          (fe === void 0 &&
            (G === "instanceMatrix" &&
              P.instanceMatrix &&
              (fe = P.instanceMatrix),
            G === "instanceColor" && P.instanceColor && (fe = P.instanceColor)),
          he === void 0 || he.attribute !== fe || (fe && he.data !== fe.data))
        )
          return !0;
        j++;
      }
    return c.attributesNum !== j || c.index !== Y;
  }
  function E(P, z, q, Y) {
    const ie = {},
      Z = z.attributes;
      ...
      if (U[G].location >= 0) {
        ...
        he === void 0 &&
          (G === "instanceMatrix" &&
            P.instanceMatrix &&
            (he = P.instanceMatrix),
          G === "instanceColor" && P.instanceColor && (he = P.instanceColor));
        const fe = {};
        (fe.attribute = he),
    ...
    (c.attributes = ie), (c.attributesNum = j), (c.index = Y);
  }
  function S() {
    const P = c.newAttributes;
    for (let z = 0, q = P.length; z < q; z++) P[z] = 0;
  }
  function T(P) {
    A(P, 0);
  }
  function A(P, z) {
    ...
    (q[P] = 1),
      Y[P] === 0 && (i.enableVertexAttribArray(P), (Y[P] = 1)),
      ie[P] !== z &&
  ...
  function C() {
    ...
    for (let q = 0, Y = z.length; q < Y; q++)
      z[q] !== P[q] && (i.disableVertexAttribArray(q), (z[q] = 0));
  }
  function w(P, z, q, Y, ie, Z, j) {
    j === !0
      ? i.vertexAttribIPointer(P, z, q, ie, Z)
      : i.vertexAttribPointer(P, z, q, Y, ie, Z);
  }
  function V(P, z, q, Y) {
    if (
      n.isWebGL2 === !1 &&
      (P.isInstancedMesh || Y.isInstancedBufferGeometry) &&
      e.get("ANGLE_instanced_arrays") === null
    )
      return;
    S();
    const ie = Y.attributes,
      Z = q.getAttributes(),
        ...
        if (
          (ce === void 0 &&
            (U === "instanceMatrix" &&
              P.instanceMatrix &&
              (ce = P.instanceMatrix),
            U === "instanceColor" && P.instanceColor && (ce = P.instanceColor)),
          ce !== void 0)
        ) {
          ...
          const Be = ye.buffer,
            Te = ye.type,
            Re = ye.bytesPerElement,
            qe =
              n.isWebGL2 === !0 &&
              (Te === i.INT || Te === i.UNSIGNED_INT || ce.gpuType === Ao);
          if (ce.isInterleavedBufferAttribute) {
            ...
            if (Ie.isInstancedInterleavedBuffer) {
              for (let xe = 0; xe < G.locationSize; xe++)
                A(G.location + xe, Ie.meshPerAttribute);
              P.isInstancedMesh !== !0 &&
                Y._maxInstanceCount === void 0 &&
                (Y._maxInstanceCount = Ie.meshPerAttribute * Ie.count);
            } else
              for (let xe = 0; xe < G.locationSize; xe++) T(G.location + xe);
            ...
            for (let xe = 0; xe < G.locationSize; xe++)
              w(
                ...
                he,
                N * Re,
                (ht + (fe / G.locationSize) * xe) * Re,
                qe
              );
          } else {
            if (ce.isInstancedBufferAttribute) {
              for (let Ie = 0; Ie < G.locationSize; Ie++)
                A(G.location + Ie, ce.meshPerAttribute);
              P.isInstancedMesh !== !0 &&
                Y._maxInstanceCount === void 0 &&
                (Y._maxInstanceCount = ce.meshPerAttribute * ce.count);
            } else
              for (let Ie = 0; Ie < G.locationSize; Ie++) T(G.location + Ie);
            i.bindBuffer(i.ARRAY_BUFFER, Be);
            for (let Ie = 0; Ie < G.locationSize; Ie++)
              w(
                G.location + Ie,
          ...
          if (he !== void 0)
            switch (he.length) {
              case 2:
                i.vertexAttrib2fv(G.location, he);
                break;
              case 3:
                i.vertexAttrib3fv(G.location, he);
                break;
              case 4:
                i.vertexAttrib4fv(G.location, he);
                break;
              default:
                i.vertexAttrib1fv(G.location, he);
            }
        }
      }
    }
  ...
  function M() {
    ...
    for (const P in a) {
      ...
      for (const q in z) {
        const Y = z[q];
        for (const ie in Y) v(Y[ie].object), delete Y[ie];
        delete z[q];
      }
      delete a[P];
    }
...
function Wd(i) {
  let e = new WeakMap();
  function t(o, a) {
    return a === ms ? (o.mapping = li) : a === gs && (o.mapping = ci), o;
  }
  function n(o) {
...
class Ya {
  ...
  fromScene(e, t = 0, n = 0.1, r = 100) {
    (rs = this._renderer.getRenderTarget()),
      (ss = this._renderer.getActiveCubeFace()),
      (as = this._renderer.getActiveMipmapLevel()),
      this._setSize(256);
  ...
  compileCubemapShader() {
    this._cubemapMaterial === null &&
      ((this._cubemapMaterial = ja()),
      this._compileMaterial(this._cubemapMaterial));
  }
  compileEquirectangularShader() {
    this._equirectMaterial === null &&
      ((this._equirectMaterial = $a()),
  ...
  _cleanup(e) {
    this._renderer.setRenderTarget(rs, ss, as),
      (e.scissorTest = !1),
      lr(e, 0, 0, e.width, e.height);
  }
  _fromTexture(e, t) {
    e.mapping === li || e.mapping === ci
      ? this._setSize(
  ...
  _allocateTargets() {
    ...
    if (
      ...
      this._pingPongRenderTarget !== null && this._dispose(),
        (this._pingPongRenderTarget = qa(e, t, n));
      ...
      ({
        ...
        (this._blurMaterial = Yd(s, e, t));
    }
    return r;
  }
  _compileMaterial(e) {
    const t = new ct(this._lodPlanes[0], e);
    this._renderer.compile(t, is);
  }
  _sceneToCubeUV(e, t, n, r) {
    const a = new wt(90, 1, t, n),
      ...
      d = u.autoClear,
      f = u.toneMapping;
    u.getClearColor(Wa), (u.toneMapping = fn), (u.autoClear = !1);
    const m = new Go({
  ...
  _textureToCubeUV(e, t) {
    const n = this._renderer,
      r = e.mapping === li || e.mapping === ci;
    r
      ? (this._cubemapMaterial === null && (this._cubemapMaterial = ja()),
        (this._cubemapMaterial.uniforms.flipEnvMap.value =
          e.isRenderTargetTexture === !1 ? -1 : 1))
      : this._equirectMaterial === null && (this._equirectMaterial = $a());
    const s = r ? this._cubemapMaterial : this._equirectMaterial,
      o = new ct(this._lodPlanes[0], s),
      a = s.uniforms;
    a.envMap.value = e;
    const l = this._cubeSize;
    lr(t, 0, 0, 3 * l, 2 * l), n.setRenderTarget(t), n.render(o, is);
  }
  _applyPMREM(e) {
  ...
  _halfBlur(e, t, n, r, s, o, a) {
    ...
    const u = 3,
      d = new ct(this._lodPlanes[r], c),
      f = c.uniforms,
      m = this._sizeLods[n] - 1,
      v = isFinite(s) ? Math.PI / (2 * m) : (2 * Math.PI) / (2 * Cn - 1),
      _ = s / v,
      p = isFinite(s) ? 1 + Math.floor(u * _) : Cn;
    p > Cn &&
      console.warn(
        `sigmaRadians, ${s}, is too large and will clip, as it requested ${p} samples when the maximum is set to ${Cn}`
      );
    const h = [];
    let E = 0;
    for (let w = 0; w < Cn; ++w) {
      const V = w / _,
        M = Math.exp((-V * V) / 2);
      h.push(M), w === 0 ? (E += M) : w < p && (E += 2 * M);
    }
    for (let w = 0; w < h.length; w++) h[w] = h[w] / E;
    ...
    const T = this._sizeLods[r],
      A = 3 * T * (r > S - ri ? r - S + ri : 0),
      C = 4 * (this._cubeSize - T);
    lr(t, A, C, 3 * T, 2 * T), l.setRenderTarget(t), l.render(d, is);
  }
}
function Xd(i) {
  const e = [],
    ...
    n = [];
  let r = i;
  const s = i - ri + 1 + ka.length;
  for (let o = 0; o < s; o++) {
    const a = Math.pow(2, r);
    t.push(a);
    let l = 1 / a;
    o > i - ri ? (l = ka[o - i + ri - 1]) : o === 0 && (l = 0), n.push(l);
    const c = 1 / (a - 2),
      u = -c,
      d = 1 + c,
    ...
    for (let C = 0; C < m; C++) {
      ...
      E.set(M, _ * v * C), S.set(f, p * v * C);
      const b = [C, C, C, C, C, C];
      T.set(b, h * v * C);
    }
    const A = new nn();
    A.setAttribute("position", new Wt(E, _)),
      A.setAttribute("uv", new Wt(S, p)),
      A.setAttribute("faceIndex", new Wt(T, h)),
      e.push(A),
      r > ri && r--;
  }
...
function jd(i, e, t, n) {
  ...
  function c(d) {
    ...
    if (m !== null) {
      const E = m.array;
      _ = m.version;
      for (let S = 0, T = E.length; S < T; S += 3) {
        const A = E[S + 0],
          C = E[S + 1],
          w = E[S + 2];
        f.push(A, C, C, w, w, A);
      ...
      const E = v.array;
      _ = v.version;
      for (let S = 0, T = E.length / 3 - 1; S < T; S += 3) {
        const A = S + 0,
          C = S + 1,
          w = S + 2;
        f.push(A, C, C, w, w, A);
  ...
  function l(c, u, d) {
    ...
    if (e.isWebGL2 === !0) {
      ...
      if (p === void 0 || p.count !== _) {
        let z = function () {
          K.dispose(), s.delete(u), u.removeEventListener("dispose", z);
        };
        var m = z;
        ...
        for (let q = 0; q < _; q++) {
          ...
          for (let U = 0; U < Y.count; U++) {
            const G = U * P;
            S === !0 &&
              (o.fromBufferAttribute(Y, U),
              (X[j + G + 0] = o.x),
              (X[j + G + 1] = o.y),
              (X[j + G + 2] = o.z),
              (X[j + G + 3] = 0)),
              T === !0 &&
                (o.fromBufferAttribute(ie, U),
                (X[j + G + 4] = o.x),
                (X[j + G + 5] = o.y),
                (X[j + G + 6] = o.z),
                (X[j + G + 7] = 0)),
              A === !0 &&
                (o.fromBufferAttribute(Z, U),
                (X[j + G + 8] = o.x),
                (X[j + G + 9] = o.y),
                (X[j + G + 10] = o.z),
                (X[j + G + 11] = Z.itemSize === 4 ? o.w : 1));
          }
        }
        (p = { count: _, texture: K, size: new Ce(b, W) }),
          s.set(u, p),
          u.addEventListener("dispose", z);
      }
      let h = 0;
      for (let S = 0; S < f.length; S++) h += f[S];
      const E = u.morphTargetsRelative ? 1 : 1 - h;
      d.getUniforms().setValue(i, "morphTargetBaseInfluence", E),
      ...
      const S = u.morphTargetsRelative ? 1 : 1 - E;
...
function fi(i, e, t) {
  ...
  const r = e * t;
  let s = Ka[r];
  if ((s === void 0 && ((s = new Float32Array(r)), (Ka[r] = s)), e !== 0)) {
    n.toArray(s, 0);
...
function of(i, e) {
  ...
  if (n === void 0) {
    ...
    if (rt(t, n)) return;
    eo.set(n), i.uniformMatrix2fv(this.addr, !1, eo), st(t, n);
  }
}
function lf(i, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (rt(t, n)) return;
    Qa.set(n), i.uniformMatrix3fv(this.addr, !1, Qa), st(t, n);
  }
}
function cf(i, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (rt(t, n)) return;
    Ja.set(n), i.uniformMatrix4fv(this.addr, !1, Ja), st(t, n);
  }
}
function hf(i, e) {
  const t = this.cache;
...
function vf(i, e, t) {
  ...
  n[0] !== r && (i.uniform1i(this.addr, r), (n[0] = r)),
    t.setTexture2D(e || jo, r);
}
function xf(i, e, t) {
  const n = this.cache,
    r = t.allocateTextureUnit();
  n[0] !== r && (i.uniform1i(this.addr, r), (n[0] = r)),
    t.setTexture3D(e || Zo, r);
}
function Mf(i, e, t) {
  const n = this.cache,
    r = t.allocateTextureUnit();
  n[0] !== r && (i.uniform1i(this.addr, r), (n[0] = r)),
    t.setTextureCube(e || Jo, r);
}
function Sf(i, e, t) {
  const n = this.cache,
    r = t.allocateTextureUnit();
  n[0] !== r && (i.uniform1i(this.addr, r), (n[0] = r)),
    t.setTexture2DArray(e || Ko, r);
}
function Ef(i) {
  switch (i) {
    case 5126:
...
function Bf(i, e, t) {
  ...
  for (let o = 0; o !== r; ++o) t.setTexture2D(e[o] || jo, s[o]);
}
function zf(i, e, t) {
  const n = this.cache,
    r = e.length,
    s = Mr(t, r);
  rt(n, s) || (i.uniform1iv(this.addr, s), st(n, s));
  for (let o = 0; o !== r; ++o) t.setTexture3D(e[o] || Zo, s[o]);
}
function Hf(i, e, t) {
  const n = this.cache,
    r = e.length,
    s = Mr(t, r);
  rt(n, s) || (i.uniform1iv(this.addr, s), st(n, s));
  for (let o = 0; o !== r; ++o) t.setTextureCube(e[o] || Jo, s[o]);
}
function Gf(i, e, t) {
  const n = this.cache,
    r = e.length,
    s = Mr(t, r);
  rt(n, s) || (i.uniform1iv(this.addr, s), st(n, s));
  for (let o = 0; o !== r; ++o) t.setTexture2DArray(e[o] || Ko, s[o]);
}
function Vf(i) {
  switch (i) {
    case 5126:
...
function Yf(i, e, t) {
  ...
  for (os.lastIndex = 0; ; ) {
    ...
    if ((l && (a = a | 0), c === void 0 || (c === "[" && o + 2 === r))) {
      to(t, c === void 0 ? new kf(a, i, e) : new Wf(a, i, e));
      break;
    } else {
      let d = t.map[a];
      d === void 0 && ((d = new Xf(a)), to(t, d)), (t = d);
    }
  }
}
class hr {
...
`)),
      (h = [
        ...
        t.toneMapping !== fn ? Jf("toneMapping", t.toneMapping) : "",
...
` +
  ...
  const S = E + p + o,
    T = E + h + a,
    A = no(r, r.VERTEX_SHADER, S),
    C = no(r, r.FRAGMENT_SHADER, T);
  r.attachShader(_, A),
    r.attachShader(_, C),
...
` +
      ...
      q &&
        (W.diagnostics = {
          ...
          fragmentShader: { log: P, prefix: h },
        });
    }
    r.deleteShader(A), r.deleteShader(C), (V = new hr(r, _)), (M = tp(r, _));
  }
  let V;
  ...
  return (
    (this.isReady = function () {
      return b === !1 && (b = r.getProgramParameter(_, qf)), b;
    }),
...
function gp(i, e, t, n, r, s, o) {
  ...
  function p(M, b, W, X, K) {
    const P = X.fog,
      z = K.geometry,
      q = M.isMeshStandardMaterial ? X.environment : null,
      Y = (M.isMeshStandardMaterial ? t : e).get(M.envMap || q),
      ie = Y && Y.mapping === _r ? Y.image.height : null,
      Z = v[M.type];
    M.precision !== null &&
    ...
    let G = 0;
    z.morphAttributes.position !== void 0 && (G = 1),
      z.morphAttributes.normal !== void 0 && (G = 2),
      z.morphAttributes.color !== void 0 && (G = 3);
    let ce, he, fe, ye;
    if (Z) {
      const et = Vt[Z];
      (ce = et.vertexShader), (he = et.fragmentShader);
    } else
      (ce = M.vertexShader),
        (he = M.fragmentShader),
        l.update(M),
    ...
    const Be = i.getRenderTarget(),
      Te = K.isInstancedMesh === !0,
      Re = !!M.map,
      qe = !!M.matcap,
      Ie = !!Y,
      N = !!M.aoMap,
      ...
      y = M.sheen > 0,
      g = M.transmission > 0,
      F = Ve && !!M.anisotropyMap,
      ee = Qe && !!M.clearcoatMap,
      J = Qe && !!M.clearcoatNormalMap,
      te = Qe && !!M.clearcoatRoughnessMap,
      me = at && !!M.iridescenceMap,
      se = at && !!M.iridescenceThicknessMap,
      le = y && !!M.sheenColorMap,
      R = y && !!M.sheenRoughnessMap,
      re = !!M.specularMap,
      $ = !!M.specularColorMap,
      Se = !!M.specularIntensityMap,
      ge = g && !!M.transmissionMap,
      Me = g && !!M.thicknessMap,
      pe = !!M.gradientMap,
      de = !!M.alphaMap,
      ze = M.alphaTest > 0,
    ...
    return (
        ...
        (ve = i.toneMapping),
      {
        ...
        emissiveMap: je,
        normalMapObjectSpace: be && M.normalMapType === dc,
        normalMapTangentSpace: be && M.normalMapType === Uo,
        metalnessMap: De,
        roughnessMap: Le,
        anisotropy: Ve,
        anisotropyMap: F,
        ...
        thicknessMap: Me,
        gradientMap: pe,
        opaque: M.transparent === !1 && M.blending === ai,
        alphaMap: de,
        alphaTest: ze,
        alphaHash: L,
        combine: M.combine,
        mapUv: Re && _(M.map.channel),
        aoMapUv: N && _(M.aoMap.channel),
        lightMapUv: ht && _(M.lightMap.channel),
        bumpMapUv: xe && _(M.bumpMap.channel),
        normalMapUv: be && _(M.normalMap.channel),
        displacementMapUv: Ae && _(M.displacementMap.channel),
        emissiveMapUv: je && _(M.emissiveMap.channel),
        metalnessMapUv: De && _(M.metalnessMap.channel),
        roughnessMapUv: Le && _(M.roughnessMap.channel),
        ...
        specularIntensityMapUv: Se && _(M.specularIntensityMap.channel),
        ...
        vertexTangents: !!z.attributes.tangent && (be || Ve),
        ...
        vertexUv2s: k,
        vertexUv3s: ne,
        pointsUvs: K.isPoints === !0 && !!z.attributes.uv && (Re || de),
        fog: !!P,
        useFog: M.fog === !0,
        ...
        decodeVideoTexture:
          ...
          Xe.getTransfer(M.map.colorSpace) === $e,
  ...
  function h(M) {
    ...
    if (
      ...
      for (const W in M.defines) b.push(W), b.push(M.defines[W]);
    return (
      M.isRawShaderMaterial === !1 &&
        (E(b, M), S(b, M), b.push(i.outputColorSpace)),
  ...
  function A(M, b) {
    ...
    return W === void 0 && ((W = new dp(i, b, M, s)), c.push(W)), W;
  }
  function C(M) {
    if (--M.usedTimes === 0) {
      const b = c.indexOf(M);
...
function co() {
  ...
  function c(d, f) {
    t.length > 1 && t.sort(d || vp),
      n.length > 1 && n.sort(f || lo),
      r.length > 1 && r.sort(f || lo);
  }
  function u() {
    ...
    get: function (e) {
      ...
      switch (e.type) {
        case "DirectionalLight":
          t = { direction: new D(), color: new ke() };
          break;
        case "SpotLight":
          t = {
            position: new D(),
          ...
          break;
        case "PointLight":
          t = { position: new D(), color: new ke(), distance: 0, decay: 0 };
          break;
        case "HemisphereLight":
          t = { direction: new D(), skyColor: new ke(), groundColor: new ke() };
          break;
        case "RectAreaLight":
          t = {
            color: new ke(),
  ...
  function l(u, d) {
    ...
    for (let X = 0, K = u.length; X < K; X++) {
      const P = u[X],
        ...
        q = P.intensity,
        Y = P.distance,
        ie = P.shadow && P.shadow.map ? P.shadow.map.texture : null;
      if (P.isAmbientLight)
        (f += z.r * q * b), (m += z.g * q * b), (v += z.b * q * b);
      else if (P.isLightProbe) {
        for (let Z = 0; Z < 9; Z++)
          r.probe[Z].addScaledVector(P.sh.coefficients[Z], q);
        M++;
      } else if (P.isDirectionalLight) {
        const Z = t.get(P);
        if (
          (Z.color.copy(P.color).multiplyScalar(P.intensity * b), P.castShadow)
        ) {
          const j = P.shadow,
            U = n.get(P);
          (U.shadowBias = j.bias),
            ...
            (r.directionalShadow[_] = U),
            (r.directionalShadowMap[_] = ie),
            (r.directionalShadowMatrix[_] = P.shadow.matrix),
            T++;
        }
        (r.directional[_] = Z), _++;
        ...
        Z.position.setFromMatrixPosition(P.matrixWorld),
          Z.color.copy(z).multiplyScalar(q * b),
          (Z.distance = Y),
        ...
        const Z = t.get(P);
        Z.color.copy(z).multiplyScalar(q),
        ...
        const Z = t.get(P);
        if (
          (Z.color.copy(P.color).multiplyScalar(P.intensity * b),
        ...
        const Z = t.get(P);
        Z.skyColor.copy(P.color).multiplyScalar(q * b),
          Z.groundColor.copy(P.groundColor).multiplyScalar(q * b),
          (r.hemi[S] = Z),
          S++;
      }
    }
    ...
    (W.directionalLength !== _ ||
      ...
      (r.spotLightMatrix.length = C + w - V),
    ...
    for (let E = 0, S = u.length; E < S; E++) {
      ...
      if (T.isDirectionalLight) {
        ...
        A.position.setFromMatrixPosition(T.matrixWorld),
          ...
          o.premultiply(h),
          a.extractRotation(o),
          A.halfWidth.set(T.width * 0.5, 0, 0),
          A.halfHeight.set(0, T.height * 0.5, 0),
...
function bp(i, e) {
  ...
  function n(s, o = 0) {
    ...
    return (
      a === void 0
        ? ((l = new ho(i, e)), t.set(s, [l]))
        : o >= a.length
        ? ((l = new ho(i, e)), a.push(l))
        : (l = a[o]),
      l
    );
  }
...
function Lp(i, e, t) {
  ...
  this.render = function (A, C, w) {
    ...
    W.setBlending(dn),
      ...
      W.setScissorTest(!1);
    const X = h !== Jt && this.type === Jt,
      K = h === Jt && this.type !== Jt;
    for (let P = 0, z = A.length; P < z; P++) {
      const q = A[P],
        Y = q.shadow;
      if (Y === void 0) {
      ...
      if (
        ...
        const j = this.type !== Jt ? { minFilter: xt, magFilter: xt } : {};
        Y.map !== null && Y.map.dispose(),
          (Y.map = new Un(r.x, r.y, j)),
          (Y.map.texture.name = q.name + ".shadowMap"),
          Y.camera.updateProjectionMatrix();
      }
      i.setRenderTarget(Y.map), i.clear();
      const Z = Y.getViewportCount();
      for (let j = 0; j < Z; j++) {
        const U = Y.getViewport(j);
        o.set(s.x * U.x, s.y * U.y, s.x * U.z, s.y * U.w),
          W.viewport(o),
          Y.updateMatrices(q, j),
          (n = Y.getFrustum()),
          T(C, w, Y.camera, q, this.type);
      }
      Y.isPointLightShadow !== !0 && this.type === Jt && E(Y, w),
        (Y.needsUpdate = !1);
    }
    (h = this.type), (p.needsUpdate = !1), i.setRenderTarget(V, M, b);
  };
  function E(A, C) {
    const w = e.update(_);
    f.defines.VSM_SAMPLES !== A.blurSamples &&
      ...
      (f.needsUpdate = !0),
      (m.needsUpdate = !0)),
      A.mapPass === null && (A.mapPass = new Un(r.x, r.y)),
      ...
      i.clear(),
      i.renderBufferDirect(C, null, w, f, _, null),
      ...
      i.clear(),
      i.renderBufferDirect(C, null, w, m, _, null);
  }
  function S(A, C, w, V) {
    let M = null;
    const b =
    ...
    if (
      ...
      w.isPointLight === !0 && M.isMeshDistanceMaterial === !0)
    ) {
      const W = i.properties.get(M);
      W.light = w;
    }
    return M;
  }
  function T(A, C, w, V, M) {
    if (A.visible === !1) return;
    if (
      A.layers.test(C.layers) &&
      (A.isMesh || A.isLine || A.isPoints) &&
      (A.castShadow || (A.receiveShadow && M === Jt)) &&
      ...
      if (Array.isArray(K)) {
        ...
        for (let z = 0, q = P.length; z < q; z++) {
          const Y = P[z],
            ie = K[Y.materialIndex];
          if (ie && ie.visible) {
            const Z = S(A, ie, V, M);
            i.renderBufferDirect(w, null, X, Z, A, Y);
          }
        }
      } else if (K.visible) {
        const P = S(A, K, V, M);
        i.renderBufferDirect(w, null, X, P, A, null);
      }
    }
    const W = A.children;
    for (let X = 0, K = W.length; X < K; X++) T(W[X], C, w, V, M);
  }
}
function Pp(i, e, t) {
  const n = t.isWebGL2;
  function r() {
    ...
    return {
      setMask: function (ne) {
        Q !== ne && !L && (i.colorMask(ne, ne, ne, ne), (Q = ne));
      },
      setLocked: function (ne) {
        L = ne;
      },
      setClear: function (ne, ve, He, et, Ct) {
        Ct === !0 && ((ne *= et), (ve *= et), (He *= et)),
          ae.set(ne, ve, He, et),
          k.equals(ae) === !1 && (i.clearColor(ne, ve, He, et), k.copy(ae));
      },
      reset: function () {
        (L = !1), (Q = null), k.set(-1, 0, 0, 0);
      },
    };
  }
  function s() {
    ...
    return {
      setTest: function (ne) {
        ne ? Re(i.DEPTH_TEST) : qe(i.DEPTH_TEST);
      },
      setMask: function (ne) {
        ae !== ne && !L && (i.depthMask(ne), (ae = ne));
      },
      setFunc: function (ne) {
        if (Q !== ne) {
          switch (ne) {
      ...
      setClear: function (ne) {
        k !== ne && (i.clearDepth(ne), (k = ne));
      },
      reset: function () {
        (L = !1), (ae = null), (Q = null), (k = null);
      },
    };
  }
  function o() {
    ...
    return {
      setTest: function (Ye) {
        L || (Ye ? Re(i.STENCIL_TEST) : qe(i.STENCIL_TEST));
      },
      setMask: function (Ye) {
        ae !== Ye && !L && (i.stencilMask(Ye), (ae = Ye));
      },
      setFunc: function (Ye, mt, Gt) {
        (Q !== Ye || k !== mt || ne !== Gt) &&
          (i.stencilFunc(Ye, mt, Gt), (Q = Ye), (k = mt), (ne = Gt));
      },
      setOp: function (Ye, mt, Gt) {
        (ve !== Ye || He !== mt || et !== Gt) &&
          (i.stencilOp(Ye, mt, Gt), (ve = Ye), (He = mt), (et = Gt));
      },
      setLocked: function (Ye) {
        L = Ye;
      },
      setClear: function (Ye) {
        Ct !== Ye && (i.clearStencil(Ye), (Ct = Ye));
      },
      reset: function () {
        (L = !1),
          (ae = null),
  ...
  j.indexOf("WebGL") !== -1
    ? ((Z = parseFloat(/^WebGL (\d)/.exec(j)[1])), (ie = Z >= 1))
    : j.indexOf("OpenGL ES") !== -1 &&
      ((Z = parseFloat(/^OpenGL ES (\d)/.exec(j)[1])), (ie = Z >= 2));
  let U = null,
    G = {};
  const ce = i.getParameter(i.SCISSOR_BOX),
    he = i.getParameter(i.VIEWPORT),
    fe = new Ke().fromArray(ce),
    ye = new Ke().fromArray(he);
  function Be(L, ae, Q, k) {
    ...
    for (let He = 0; He < Q; He++)
      n && (L === i.TEXTURE_3D || L === i.TEXTURE_2D_ARRAY)
        ? i.texImage3D(ae, 0, i.RGBA, 1, 1, k, 0, i.RGBA, i.UNSIGNED_BYTE, ne)
        : i.texImage2D(
            ae + He,
            0,
            i.RGBA,
  ...
  const Te = {};
  (Te[i.TEXTURE_2D] = Be(i.TEXTURE_2D, i.TEXTURE_2D, 1)),
    (Te[i.TEXTURE_CUBE_MAP] = Be(
      i.TEXTURE_CUBE_MAP,
      i.TEXTURE_CUBE_MAP_POSITIVE_X,
      6
    )),
    n &&
      ((Te[i.TEXTURE_2D_ARRAY] = Be(
        i.TEXTURE_2D_ARRAY,
        i.TEXTURE_2D_ARRAY,
        1,
        1
      )),
      (Te[i.TEXTURE_3D] = Be(i.TEXTURE_3D, i.TEXTURE_3D, 1, 1))),
    a.setClear(0, 0, 0, 1),
    l.setClear(1),
    c.setClear(0),
    Re(i.DEPTH_TEST),
  ...
  function Ie(L, ae) {
    return m[L] !== ae
      ? (i.bindFramebuffer(L, ae),
        (m[L] = ae),
        n &&
          (L === i.DRAW_FRAMEBUFFER && (m[i.FRAMEBUFFER] = ae),
          L === i.FRAMEBUFFER && (m[i.DRAW_FRAMEBUFFER] = ae)),
        !0)
      : !1;
  }
  function N(L, ae) {
    ...
    if (L)
      if (
        ((Q = v.get(ae)),
        Q === void 0 && ((Q = []), v.set(ae, Q)),
        L.isWebGLMultipleRenderTargets)
      ) {
        const ne = L.texture;
        if (Q.length !== ne.length || Q[0] !== i.COLOR_ATTACHMENT0) {
          for (let ve = 0, He = ne.length; ve < He; ve++)
            Q[ve] = i.COLOR_ATTACHMENT0 + ve;
          (Q.length = ne.length), (k = !0);
        }
      } else
        Q[0] !== i.COLOR_ATTACHMENT0 &&
          ((Q[0] = i.COLOR_ATTACHMENT0), (k = !0));
    else Q[0] !== i.BACK && ((Q[0] = i.BACK), (k = !0));
    k &&
      (t.isWebGL2
        ? i.drawBuffers(Q)
  ...
  const xe = {
    [Rn]: i.FUNC_ADD,
    [bl]: i.FUNC_SUBTRACT,
    [Al]: i.FUNC_REVERSE_SUBTRACT,
  };
  if (n) (xe[js] = i.MIN), (xe[Ks] = i.MAX);
  else {
    const L = e.get("EXT_blend_minmax");
    L !== null && ((xe[js] = L.MIN_EXT), (xe[Ks] = L.MAX_EXT));
  }
  const be = {
    [wl]: i.ZERO,
    [Rl]: i.ONE,
    [Cl]: i.SRC_COLOR,
    [fs]: i.SRC_ALPHA,
    [Nl]: i.SRC_ALPHA_SATURATE,
    [Ul]: i.DST_COLOR,
    [Pl]: i.DST_ALPHA,
    [Ll]: i.ONE_MINUS_SRC_COLOR,
    [ps]: i.ONE_MINUS_SRC_ALPHA,
    [Il]: i.ONE_MINUS_DST_COLOR,
    [Dl]: i.ONE_MINUS_DST_ALPHA,
    [Fl]: i.CONSTANT_COLOR,
    [Ol]: i.ONE_MINUS_CONSTANT_COLOR,
    [Bl]: i.CONSTANT_ALPHA,
    [zl]: i.ONE_MINUS_CONSTANT_ALPHA,
  };
  function Ae(L, ae, Q, k, ne, ve, He, et, Ct, Ye) {
    if (L === dn) {
      h === !0 && (qe(i.BLEND), (h = !1));
      return;
    }
    if ((h === !1 && (Re(i.BLEND), (h = !0)), L !== Tl)) {
      if (L !== E || Ye !== W) {
        if (
          ((S !== Rn || C !== Rn) &&
            (i.blendEquation(i.FUNC_ADD), (S = Rn), (C = Rn)),
          Ye)
        )
          switch (L) {
            case ai:
    ...
    (ne = ne || ae),
      ...
      (He = He || k),
      (ae !== S || ne !== C) &&
        (i.blendEquationSeparate(xe[ae], xe[ne]), (S = ae), (C = ne)),
      (Q !== T || k !== A || ve !== w || He !== V) &&
        (i.blendFuncSeparate(be[Q], be[k], be[ve], be[He]),
        (T = Q),
        (A = k),
        (w = ve),
        (V = He)),
      (et.equals(M) === !1 || Ct !== b) &&
        (i.blendColor(et.r, et.g, et.b, Ct), M.copy(et), (b = Ct)),
      (E = L),
      (W = !1);
  }
  function je(L, ae) {
    L.side === Qt ? qe(i.CULL_FACE) : Re(i.CULL_FACE);
    let Q = L.side === St;
    ae && (Q = !Q),
      De(Q),
      L.blending === ai && L.transparent === !1
        ? Ae(dn)
        : Ae(
            L.blending,
            L.blendEquation,
  ...
  function De(L) {
    X !== L && (L ? i.frontFace(i.CW) : i.frontFace(i.CCW), (X = L));
  }
  function Le(L) {
    L !== El
      ? (Re(i.CULL_FACE),
  ...
  function Ve(L) {
    L !== P && (ie && i.lineWidth(L), (P = L));
  }
  function Qe(L, ae, Q) {
    L
      ? (Re(i.POLYGON_OFFSET_FILL),
        (z !== ae || q !== Q) && (i.polygonOffset(ae, Q), (z = ae), (q = Q)))
      : qe(i.POLYGON_OFFSET_FILL);
  }
  function at(L) {
    L ? Re(i.SCISSOR_TEST) : qe(i.SCISSOR_TEST);
  }
  function y(L) {
    L === void 0 && (L = i.TEXTURE0 + Y - 1),
      U !== L && (i.activeTexture(L), (U = L));
  }
  function g(L, ae, Q) {
    Q === void 0 && (U === null ? (Q = i.TEXTURE0 + Y - 1) : (Q = U));
    let k = G[Q];
    k === void 0 && ((k = { type: void 0, texture: void 0 }), (G[Q] = k)),
      (k.type !== L || k.texture !== ae) &&
        (U !== Q && (i.activeTexture(Q), (U = Q)),
        i.bindTexture(L, ae || Te[L]),
        (k.type = L),
        (k.texture = ae));
  }
  function F() {
  ...
  function ge(L) {
    fe.equals(L) === !1 && (i.scissor(L.x, L.y, L.z, L.w), fe.copy(L));
  }
  function Me(L) {
    ye.equals(L) === !1 && (i.viewport(L.x, L.y, L.z, L.w), ye.copy(L));
  }
  function pe(L, ae) {
    let Q = d.get(ae);
    Q === void 0 && ((Q = new WeakMap()), d.set(ae, Q));
    let k = Q.get(L);
    k === void 0 && ((k = i.getUniformBlockIndex(ae, L.name)), Q.set(L, k));
  }
  function de(L, ae) {
    const k = d.get(ae).get(L);
    u.get(ae) !== k &&
      (i.uniformBlockBinding(ae, k, L.__bindingPointIndex), u.set(ae, k));
  }
  function ze() {
    i.disable(i.BLEND),
...
function Dp(i, e, t, n, r, s, o) {
  ...
  function E(y, g) {
    return h ? new OffscreenCanvas(y, g) : Ci("canvas");
  }
  function S(y, g, F, ee) {
    let J = 1;
    if (
      ((y.width > ee || y.height > ee) &&
        (J = ee / Math.max(y.width, y.height)),
      J < 1 || g === !0)
    )
      if (
        ...
        const te = g ? gr : Math.floor,
          me = te(J * y.width),
          se = te(J * y.height);
        _ === void 0 && (_ = E(me, se));
        const le = F ? E(me, se) : _;
        return (
          (le.width = me),
          (le.height = se),
          le.getContext("2d").drawImage(y, 0, 0, me, se),
          console.warn(
  ...
  function A(y) {
    return a
      ...
      : y.wrapS !== Bt ||
          y.wrapT !== Bt ||
          (y.minFilter !== xt && y.minFilter !== Pt);
  }
  function C(y, g) {
    return y.generateMipmaps && g && y.minFilter !== xt && y.minFilter !== Pt;
  }
  function w(y) {
    i.generateMipmap(y);
  }
  function V(y, g, F, ee, J = !1) {
    if (a === !1) return g;
    if (y !== null) {
    ...
    if (
      (g === i.RED &&
        (F === i.FLOAT && (te = i.R32F),
        F === i.HALF_FLOAT && (te = i.R16F),
        F === i.UNSIGNED_BYTE && (te = i.R8)),
      g === i.RED_INTEGER &&
        (F === i.UNSIGNED_BYTE && (te = i.R8UI),
        F === i.UNSIGNED_SHORT && (te = i.R16UI),
        F === i.UNSIGNED_INT && (te = i.R32UI),
        F === i.BYTE && (te = i.R8I),
        F === i.SHORT && (te = i.R16I),
        F === i.INT && (te = i.R32I)),
      g === i.RG &&
        (F === i.FLOAT && (te = i.RG32F),
        F === i.HALF_FLOAT && (te = i.RG16F),
        F === i.UNSIGNED_BYTE && (te = i.RG8)),
      g === i.RGBA)
    ) {
      const me = J ? dr : Xe.getTransfer(ee);
      F === i.FLOAT && (te = i.RGBA32F),
        F === i.HALF_FLOAT && (te = i.RGBA16F),
        F === i.UNSIGNED_BYTE && (te = me === $e ? i.SRGB8_ALPHA8 : i.RGBA8),
        F === i.UNSIGNED_SHORT_4_4_4_4 && (te = i.RGBA4),
        F === i.UNSIGNED_SHORT_5_5_5_1 && (te = i.RGB5_A1);
    }
    return (
      (te === i.R16F ||
        te === i.R32F ||
  ...
  function M(y, g, F) {
    return C(y, F) === !0 ||
      (y.isFramebufferTexture && y.minFilter !== xt && y.minFilter !== Pt)
  ...
  function b(y) {
    return y === xt || y === Zs || y === Ir ? i.NEAREST : i.LINEAR;
  }
  function W(y) {
    const g = y.target;
    g.removeEventListener("dispose", W), K(g), g.isVideoTexture && v.delete(g);
  }
  function X(y) {
    const g = y.target;
    g.removeEventListener("dispose", X), z(g);
  }
  function K(y) {
    const g = n.get(y);
    ...
    const F = y.source,
      ee = p.get(F);
    if (ee) {
      const J = ee[g.__cacheKey];
      J.usedTimes--,
        J.usedTimes === 0 && P(y),
        Object.keys(ee).length === 0 && p.delete(F);
    }
    n.remove(y);
  }
  function P(y) {
    ...
    const F = y.source,
      ee = p.get(F);
    delete ee[g.__cacheKey], o.memory.textures--;
  }
  function z(y) {
    const g = y.texture,
      F = n.get(y),
    ...
    if (
      (ee.__webglTexture !== void 0 &&
        (i.deleteTexture(ee.__webglTexture), o.memory.textures--),
      y.depthTexture && y.depthTexture.dispose(),
      y.isWebGLCubeRenderTarget)
    )
      for (let J = 0; J < 6; J++) {
        if (Array.isArray(F.__webglFramebuffer[J]))
          for (let te = 0; te < F.__webglFramebuffer[J].length; te++)
            i.deleteFramebuffer(F.__webglFramebuffer[J][te]);
        else i.deleteFramebuffer(F.__webglFramebuffer[J]);
        F.__webglDepthbuffer && i.deleteRenderbuffer(F.__webglDepthbuffer[J]);
      }
    else {
      if (Array.isArray(F.__webglFramebuffer))
        for (let J = 0; J < F.__webglFramebuffer.length; J++)
          i.deleteFramebuffer(F.__webglFramebuffer[J]);
      ...
      if (
        ...
        for (let J = 0; J < F.__webglColorRenderbuffer.length; J++)
          F.__webglColorRenderbuffer[J] &&
            i.deleteRenderbuffer(F.__webglColorRenderbuffer[J]);
  ...
  const he = { [Ht]: i.REPEAT, [Bt]: i.CLAMP_TO_EDGE, [_s]: i.MIRRORED_REPEAT },
    fe = {
      [xt]: i.NEAREST,
      [Zs]: i.NEAREST_MIPMAP_NEAREST,
      [Ir]: i.NEAREST_MIPMAP_LINEAR,
      [Pt]: i.LINEAR,
      [ec]: i.LINEAR_MIPMAP_NEAREST,
      [Ai]: i.LINEAR_MIPMAP_LINEAR,
    },
    ye = {
      [fc]: i.NEVER,
      [Mc]: i.ALWAYS,
  ...
  function Be(y, g, F) {
    if (
      (F
        ? (i.texParameteri(y, i.TEXTURE_WRAP_S, he[g.wrapS]),
          i.texParameteri(y, i.TEXTURE_WRAP_T, he[g.wrapT]),
          (y === i.TEXTURE_3D || y === i.TEXTURE_2D_ARRAY) &&
            i.texParameteri(y, i.TEXTURE_WRAP_R, he[g.wrapR]),
          i.texParameteri(y, i.TEXTURE_MAG_FILTER, fe[g.magFilter]),
          i.texParameteri(y, i.TEXTURE_MIN_FILTER, fe[g.minFilter]))
        : (i.texParameteri(y, i.TEXTURE_WRAP_S, i.CLAMP_TO_EDGE),
          i.texParameteri(y, i.TEXTURE_WRAP_T, i.CLAMP_TO_EDGE),
          (y === i.TEXTURE_3D || y === i.TEXTURE_2D_ARRAY) &&
            i.texParameteri(y, i.TEXTURE_WRAP_R, i.CLAMP_TO_EDGE),
          (g.wrapS !== Bt || g.wrapT !== Bt) &&
            console.warn(
              "THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."
            ),
          i.texParameteri(y, i.TEXTURE_MAG_FILTER, b(g.magFilter)),
          i.texParameteri(y, i.TEXTURE_MIN_FILTER, b(g.minFilter)),
          g.minFilter !== xt &&
            g.minFilter !== Pt &&
            console.warn(
      ...
      g.compareFunction &&
        ...
        i.texParameteri(y, i.TEXTURE_COMPARE_FUNC, ye[g.compareFunction])),
      e.has("EXT_texture_filter_anisotropic") === !0)
    ) {
      const ee = e.get("EXT_texture_filter_anisotropic");
      if (
        g.magFilter === xt ||
        (g.minFilter !== Ir && g.minFilter !== Ai) ||
        (g.type === un && e.has("OES_texture_float_linear") === !1) ||
        (a === !1 &&
          g.type === wi &&
  ...
  function Te(y, g) {
    ...
    y.__webglInit === void 0 &&
      ((y.__webglInit = !0), g.addEventListener("dispose", W));
    const ee = g.source;
    let J = p.get(ee);
    J === void 0 && ((J = {}), p.set(ee, J));
    const te = Z(g);
    if (te !== y.__cacheKey) {
      J[te] === void 0 &&
        ((J[te] = { texture: i.createTexture(), usedTimes: 0 }),
        o.memory.textures++,
        (F = !0)),
        J[te].usedTimes++;
      const me = J[y.__cacheKey];
      me !== void 0 &&
        (J[y.__cacheKey].usedTimes--, me.usedTimes === 0 && P(g)),
        (y.__cacheKey = te),
        (y.__webglTexture = J[te].texture);
    }
    return F;
  }
  function Re(y, g, F) {
    ...
    (g.isDataArrayTexture || g.isCompressedArrayTexture) &&
      (ee = i.TEXTURE_2D_ARRAY),
      g.isData3DTexture && (ee = i.TEXTURE_3D);
    const J = Te(y, g),
      te = g.source;
    t.bindTexture(ee, y.__webglTexture, i.TEXTURE0 + F);
    const me = n.get(te);
    if (te.version !== me.__version || J === !0) {
      t.activeTexture(i.TEXTURE0 + F);
      const se = Xe.getPrimaries(Xe.workingColorSpace),
        le = g.colorSpace === Dt ? null : Xe.getPrimaries(g.colorSpace),
        R = g.colorSpace === Dt || se === le ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      ...
      const re = A(g) && T(g.image) === !1;
      let $ = S(g.image, re, !1, u);
      $ = at(g, $);
      const Se = T($) || a,
        ge = s.convert(g.format, g.colorSpace);
      let Me = s.convert(g.type),
        pe = V(g.internalFormat, ge, Me, g.colorSpace, g.isVideoTexture);
      Be(ee, g, Se);
      let de;
      const ze = g.mipmaps,
        L = a && g.isVideoTexture !== !0,
        ae = me.__version === void 0 || J === !0,
        Q = M(g, $, Se);
      if (g.isDepthTexture)
        (pe = i.DEPTH_COMPONENT),
          a
            ? g.type === un
              ? (pe = i.DEPTH_COMPONENT32F)
              : g.type === hn
              ? (pe = i.DEPTH_COMPONENT24)
              : g.type === Ln
              ? (pe = i.DEPTH24_STENCIL8)
              : (pe = i.DEPTH_COMPONENT16)
            : g.type === un &&
              console.error(
          ...
          ae &&
            (L
              ? t.texStorage2D(i.TEXTURE_2D, 1, pe, $.width, $.height)
              : t.texImage2D(
                  i.TEXTURE_2D,
                  0,
                  pe,
        ...
        if (ze.length > 0 && Se) {
          L &&
            ae &&
            t.texStorage2D(i.TEXTURE_2D, Q, pe, ze[0].width, ze[0].height);
          for (let k = 0, ne = ze.length; k < ne; k++)
            (de = ze[k]),
              L
                ? t.texSubImage2D(
                    i.TEXTURE_2D,
          ...
          L
            ? (ae && t.texStorage2D(i.TEXTURE_2D, Q, pe, $.width, $.height),
              t.texSubImage2D(
                i.TEXTURE_2D,
                0,
                0,
        ...
        L
          ? (ae &&
              t.texStorage3D(i.TEXTURE_3D, Q, pe, $.width, $.height, $.depth),
            t.texSubImage3D(
              i.TEXTURE_3D,
              0,
              0,
        ...
        if (ae)
          if (L) t.texStorage2D(i.TEXTURE_2D, Q, pe, $.width, $.height);
          else {
            let k = $.width,
              ne = $.height;
            for (let ve = 0; ve < Q; ve++)
              t.texImage2D(i.TEXTURE_2D, ve, pe, k, ne, 0, ge, Me, null),
                (k >>= 1),
                (ne >>= 1);
          }
        ...
        for (let k = 0, ne = ze.length; k < ne; k++)
          (de = ze[k]),
            L
              ? t.texSubImage2D(i.TEXTURE_2D, k, 0, 0, ge, Me, de)
              : t.texImage2D(i.TEXTURE_2D, k, pe, ge, Me, de);
        g.generateMipmaps = !1;
      } else
        L
          ? (ae && t.texStorage2D(i.TEXTURE_2D, Q, pe, $.width, $.height),
            t.texSubImage2D(i.TEXTURE_2D, 0, 0, 0, ge, Me, $))
          : t.texImage2D(i.TEXTURE_2D, 0, pe, ge, Me, $);
      C(g, Se) && w(ee),
  ...
  function qe(y, g, F) {
    ...
    if (J.version !== te.__version || ee === !0) {
      ...
      const me = Xe.getPrimaries(Xe.workingColorSpace),
        se = g.colorSpace === Dt ? null : Xe.getPrimaries(g.colorSpace),
        le =
          g.colorSpace === Dt || me === se ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL, g.flipY),
        i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL, g.premultiplyAlpha),
        i.pixelStorei(i.UNPACK_ALIGNMENT, g.unpackAlignment),
        i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL, le);
      const R = g.isCompressedTexture || g.image[0].isCompressedTexture,
        re = g.image[0] && g.image[0].isDataTexture,
        $ = [];
      for (let k = 0; k < 6; k++)
        !R && !re
          ? ($[k] = S(g.image[k], !1, !0, c))
          : ($[k] = re ? g.image[k].image : g.image[k]),
          ($[k] = at(g, $[k]));
      const Se = $[0],
        ge = T(Se) || a,
        Me = s.convert(g.format, g.colorSpace),
        pe = s.convert(g.type),
        de = V(g.internalFormat, Me, pe, g.colorSpace),
        ze = a && g.isVideoTexture !== !0,
        L = te.__version === void 0 || ee === !0;
      let ae = M(g, Se, ge);
      ...
      if (R) {
        ze &&
          L &&
          t.texStorage2D(i.TEXTURE_CUBE_MAP, ae, de, Se.width, Se.height);
        for (let k = 0; k < 6; k++) {
          Q = $[k].mipmaps;
      ...
      C(g, ge) && w(i.TEXTURE_CUBE_MAP),
        (te.__version = J.version),
        g.onUpdate && g.onUpdate(g);
    }
    y.__version = g.version;
  }
  function Ie(y, g, F, ee, J, te) {
    const me = s.convert(F.format, F.colorSpace),
      se = s.convert(F.type),
      le = V(F.internalFormat, me, se, F.colorSpace);
    if (!n.get(g).__hasExternalTextures) {
      const re = Math.max(1, g.width >> te),
        $ = Math.max(1, g.height >> te);
      J === i.TEXTURE_3D || J === i.TEXTURE_2D_ARRAY
        ? t.texImage3D(J, te, le, re, $, g.depth, 0, me, se, null)
        : t.texImage2D(J, te, le, re, $, 0, me, se, null);
    }
  ...
  function N(y, g, F) {
    if (
      (i.bindRenderbuffer(i.RENDERBUFFER, y), g.depthBuffer && !g.stencilBuffer)
    ) {
      ...
      if (F || Ve(g)) {
        ...
        J &&
          J.isDepthTexture &&
          (J.type === un
            ? (ee = i.DEPTH_COMPONENT32F)
            : J.type === hn && (ee = i.DEPTH_COMPONENT24));
        const te = Le(g);
        Ve(g)
      ...
      } else i.renderbufferStorage(i.RENDERBUFFER, ee, g.width, g.height);
      ...
      for (let J = 0; J < ee.length; J++) {
        const te = ee[J],
          me = s.convert(te.format, te.colorSpace),
          se = s.convert(te.type),
          le = V(te.internalFormat, me, se, te.colorSpace),
          R = Le(g);
        F && Ve(g) === !1
          ? i.renderbufferStorageMultisample(
              i.RENDERBUFFER,
          ...
          : i.renderbufferStorage(i.RENDERBUFFER, le, g.width, g.height);
      }
    }
  ...
  function ht(y, g) {
    ...
    (!n.get(g.depthTexture).__webglTexture ||
      ...
      j(g.depthTexture, 0);
    const ee = n.get(g.depthTexture).__webglTexture,
      J = Le(g);
    ...
    else if (g.depthTexture.format === hi)
      Ve(g)
        ? f.framebufferTexture2DMultisampleEXT(
            i.FRAMEBUFFER,
            i.DEPTH_STENCIL_ATTACHMENT,
  ...
  function xe(y) {
    ...
    if (y.depthTexture && !g.__autoAllocateDepthBuffer) {
      ...
      ht(g.__webglFramebuffer, y);
    } else if (F) {
      g.__webglDepthbuffer = [];
      for (let ee = 0; ee < 6; ee++)
        t.bindFramebuffer(i.FRAMEBUFFER, g.__webglFramebuffer[ee]),
          (g.__webglDepthbuffer[ee] = i.createRenderbuffer()),
          N(g.__webglDepthbuffer[ee], y, !1);
    } else
      t.bindFramebuffer(i.FRAMEBUFFER, g.__webglFramebuffer),
        (g.__webglDepthbuffer = i.createRenderbuffer()),
        N(g.__webglDepthbuffer, y, !1);
    t.bindFramebuffer(i.FRAMEBUFFER, null);
  }
  function be(y, g, F) {
    const ee = n.get(y);
  ...
  function Ae(y) {
    ...
    y.addEventListener("dispose", X),
      y.isWebGLMultipleRenderTargets !== !0 &&
        (ee.__webglTexture === void 0 &&
          (ee.__webglTexture = i.createTexture()),
        (ee.__version = g.version),
        o.memory.textures++);
    const J = y.isWebGLCubeRenderTarget === !0,
      te = y.isWebGLMultipleRenderTargets === !0,
      me = T(y) || a;
    if (J) {
      ...
      if (te)
        if (r.drawBuffers) {
          const se = y.texture;
          for (let le = 0, R = se.length; le < R; le++) {
            const re = n.get(se[le]);
            re.__webglTexture === void 0 &&
              ((re.__webglTexture = i.createTexture()), o.memory.textures++);
          }
        } else
          console.warn(
      ...
      if (a && y.samples > 0 && Ve(y) === !1) {
        ...
        for (let le = 0; le < se.length; le++) {
          ...
          const re = s.convert(R.format, R.colorSpace),
            $ = s.convert(R.type),
            Se = V(
              R.internalFormat,
              re,
        ...
        i.bindRenderbuffer(i.RENDERBUFFER, null),
          y.depthBuffer &&
            ...
            N(F.__webglDepthRenderbuffer, y, !0)),
          t.bindFramebuffer(i.FRAMEBUFFER, null);
      }
    }
    if (J) {
      t.bindTexture(i.TEXTURE_CUBE_MAP, ee.__webglTexture),
        Be(i.TEXTURE_CUBE_MAP, g, me);
      for (let se = 0; se < 6; se++)
        if (a && g.mipmaps && g.mipmaps.length > 0)
          for (let le = 0; le < g.mipmaps.length; le++)
            Ie(
              F.__webglFramebuffer[se][le],
              y,
              g,
              i.COLOR_ATTACHMENT0,
              i.TEXTURE_CUBE_MAP_POSITIVE_X + se,
              le
            );
        else
          Ie(
      ...
      C(g, me) && w(i.TEXTURE_CUBE_MAP), t.unbindTexture();
    } else if (te) {
      const se = y.texture;
      for (let le = 0, R = se.length; le < R; le++) {
        const re = se[le],
      ...
      if (
        ...
        t.bindTexture(se, ee.__webglTexture),
        Be(se, g, me),
        a && g.mipmaps && g.mipmaps.length > 0)
      )
        for (let le = 0; le < g.mipmaps.length; le++)
          Ie(F.__webglFramebuffer[le], y, g, i.COLOR_ATTACHMENT0, se, le);
      else Ie(F.__webglFramebuffer, y, g, i.COLOR_ATTACHMENT0, se, 0);
      C(g, me) && w(se), t.unbindTexture();
    }
    y.depthBuffer && xe(y);
  }
  function je(y) {
    const g = T(y) || a,
      F = y.isWebGLMultipleRenderTargets === !0 ? y.texture : [y.texture];
    for (let ee = 0, J = F.length; ee < J; ee++) {
      const te = F[ee];
      if (C(te, g)) {
        const me = y.isWebGLCubeRenderTarget
            ? i.TEXTURE_CUBE_MAP
            : i.TEXTURE_2D,
  ...
  function De(y) {
    if (a && y.samples > 0 && Ve(y) === !1) {
      ...
      const te = [],
        me = y.stencilBuffer ? i.DEPTH_STENCIL_ATTACHMENT : i.DEPTH_ATTACHMENT,
        se = n.get(y),
        le = y.isWebGLMultipleRenderTargets === !0;
      if (le)
      ...
      for (let R = 0; R < g.length; R++) {
        te.push(i.COLOR_ATTACHMENT0 + R), y.depthBuffer && te.push(me);
        const re =
          se.__ignoreDepthValues !== void 0 ? se.__ignoreDepthValues : !1;
        if (
          (re === !1 &&
            (y.depthBuffer && (J |= i.DEPTH_BUFFER_BIT),
            y.stencilBuffer && (J |= i.STENCIL_BUFFER_BIT)),
          le &&
            i.framebufferRenderbuffer(
              i.READ_FRAMEBUFFER,
              i.COLOR_ATTACHMENT0,
              i.RENDERBUFFER,
              se.__webglColorRenderbuffer[R]
            ),
          re === !0 &&
          ...
          const $ = n.get(g[R]).__webglTexture;
          i.framebufferTexture2D(
            i.DRAW_FRAMEBUFFER,
            i.COLOR_ATTACHMENT0,
            i.TEXTURE_2D,
        ...
        i.blitFramebuffer(0, 0, F, ee, 0, 0, F, ee, J, i.NEAREST),
          m && i.invalidateFramebuffer(i.READ_FRAMEBUFFER, te);
      }
      if (
        ...
        for (let R = 0; R < g.length; R++) {
          ...
          const re = n.get(g[R]).__webglTexture;
          t.bindFramebuffer(i.FRAMEBUFFER, se.__webglFramebuffer),
            i.framebufferTexture2D(
              i.DRAW_FRAMEBUFFER,
              i.COLOR_ATTACHMENT0 + R,
...
function Up(i, e, t) {
  ...
  function r(s, o = Dt) {
    ...
    if (s === pn) return i.UNSIGNED_BYTE;
    if (s === wo) return i.UNSIGNED_SHORT_4_4_4_4;
    if (s === Ro) return i.UNSIGNED_SHORT_5_5_5_1;
    if (s === tc) return i.BYTE;
    if (s === nc) return i.SHORT;
    if (s === ys) return i.UNSIGNED_SHORT;
    if (s === Ao) return i.INT;
    if (s === hn) return i.UNSIGNED_INT;
    if (s === un) return i.FLOAT;
    if (s === wi)
      return n
        ? i.HALF_FLOAT
        : ((a = e.get("OES_texture_half_float")),
          a !== null ? a.HALF_FLOAT_OES : null);
    if (s === ic) return i.ALPHA;
    if (s === zt) return i.RGBA;
    if (s === rc) return i.LUMINANCE;
    if (s === sc) return i.LUMINANCE_ALPHA;
    if (s === Pn) return i.DEPTH_COMPONENT;
    if (s === hi) return i.DEPTH_STENCIL;
    if (s === vs)
      return (a = e.get("EXT_sRGB")), a !== null ? a.SRGB_ALPHA_EXT : null;
    if (s === ac) return i.RED;
    if (s === Co) return i.RED_INTEGER;
    if (s === oc) return i.RG;
    if (s === Lo) return i.RG_INTEGER;
    if (s === Po) return i.RGBA_INTEGER;
    if (s === Nr || s === Fr || s === Or || s === Br)
      if (l === $e)
        if (((a = e.get("WEBGL_compressed_texture_s3tc_srgb")), a !== null)) {
          if (s === Nr) return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;
          if (s === Fr) return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;
          if (s === Or) return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;
          if (s === Br) return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT;
        } else return null;
      else if (((a = e.get("WEBGL_compressed_texture_s3tc")), a !== null)) {
        if (s === Nr) return a.COMPRESSED_RGB_S3TC_DXT1_EXT;
        if (s === Fr) return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;
        if (s === Or) return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;
        if (s === Br) return a.COMPRESSED_RGBA_S3TC_DXT5_EXT;
      } else return null;
    if (s === Js || s === Qs || s === ea || s === ta)
      if (((a = e.get("WEBGL_compressed_texture_pvrtc")), a !== null)) {
        if (s === Js) return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;
        if (s === Qs) return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;
        if (s === ea) return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;
        if (s === ta) return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;
      } else return null;
    if (s === lc)
      return (
    ...
    if (s === zr || s === va || s === xa)
      if (((a = e.get("EXT_texture_compression_bptc")), a !== null)) {
        ...
        if (s === va) return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;
        if (s === xa) return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
      } else return null;
    if (s === cc || s === Ma || s === Sa || s === Ea)
      if (((a = e.get("EXT_texture_compression_rgtc")), a !== null)) {
        if (s === zr) return a.COMPRESSED_RED_RGTC1_EXT;
        if (s === Ma) return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;
        if (s === Sa) return a.COMPRESSED_RED_GREEN_RGTC2_EXT;
  ...
  constructor(e, t) {
    ...
    (this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (U) {
        let G = E[U];
        return (
          G === void 0 && ((G = new ls()), (E[U] = G)), G.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (U) {
        let G = E[U];
        return G === void 0 && ((G = new ls()), (E[U] = G)), G.getGripSpace();
      }),
      (this.getHand = function (U) {
        let G = E[U];
        return G === void 0 && ((G = new ls()), (E[U] = G)), G.getHandSpace();
      });
    function b(U) {
      const G = S.indexOf(U.inputSource);
      if (G === -1) return;
      const ce = E[G];
      ce !== void 0 &&
        (ce.update(U.inputSource, U.frame, c || o),
        ce.dispatchEvent({ type: U.type, data: U.inputSource }));
    }
    function W() {
      ...
      for (let U = 0; U < E.length; U++) {
        const G = S[U];
        G !== null && ((S[U] = null), E[U].disconnect(G));
      }
      (V = null),
        (M = null),
        e.setRenderTarget(p),
        ...
        if (((r = U), r !== null)) {
          if (
            ...
            (m = new XRWebGLLayer(r, t, G)),
              ...
              (h = new Un(m.framebufferWidth, m.framebufferHeight, {
                format: zt,
                type: pn,
            ...
            (d = new XRWebGLBinding(r, t)),
              ...
              (h = new Un(f.textureWidth, f.textureHeight, {
                format: zt,
                type: pn,
                depthTexture: new Fp(
                  f.textureWidth,
    ...
    function X(U) {
      for (let G = 0; G < U.removed.length; G++) {
        const ce = U.removed[G],
          he = S.indexOf(ce);
        he >= 0 && ((S[he] = null), E[he].disconnect(ce));
      }
    ...
    const K = new D(),
      P = new D();
    function z(U, G, ce) {
      K.setFromMatrixPosition(G.matrixWorld),
        P.setFromMatrixPosition(ce.matrixWorld);
      const he = K.distanceTo(P),
        fe = G.projectionMatrix.elements,
        ye = ce.projectionMatrix.elements,
        Be = fe[14] / (fe[10] - 1),
        Te = fe[14] / (fe[10] + 1),
        Re = (fe[9] + 1) / fe[5],
        qe = (fe[9] - 1) / fe[5],
        ...
        be = he / (-Ie + N),
        Ae = be * -Ie;
      G.matrixWorld.decompose(U.position, U.quaternion, U.scale),
        U.translateX(Ae),
        U.translateZ(be),
      ...
      const je = Be + be,
        ...
        Qe = ((Re * Te) / De) * je,
        at = ((qe * Te) / De) * je;
      U.projectionMatrix.makePerspective(Le, Ve, Qe, at, je, De),
        U.projectionMatrixInverse.copy(U.projectionMatrix).invert();
    }
    function q(U, G) {
      G === null
        ? U.matrixWorld.copy(U.matrix)
        : U.matrixWorld.multiplyMatrices(G.matrixWorld, U.matrix),
        U.matrixWorldInverse.copy(U.matrixWorld).invert();
    }
    this.updateCamera = function (U) {
      if (r === null) return;
      (w.near = A.near = T.near = U.near),
        (w.far = A.far = T.far = U.far),
        (V !== w.near || M !== w.far) &&
      ...
      const G = U.parent,
        ce = w.cameras;
      q(w, G);
      for (let he = 0; he < ce.length; he++) q(ce[he], G);
      ce.length === 2
        ? z(w, T, A)
    ...
    function Y(U, G, ce) {
      ce === null
        ...
        : (U.matrix.copy(ce.matrixWorld),
          U.matrix.invert(),
          U.matrix.multiply(G.matrixWorld)),
        U.matrix.decompose(U.position, U.quaternion, U.scale),
        U.updateMatrixWorld(!0),
        U.projectionMatrix.copy(G.projectionMatrix),
        U.projectionMatrixInverse.copy(G.projectionMatrixInverse),
        U.isPerspectiveCamera &&
          ((U.fov = Ri * 2 * Math.atan(1 / U.projectionMatrix.elements[5])),
          (U.zoom = 1));
    }
    ...
    let ie = null;
    function Z(U, G) {
      if (((u = G.getViewerPose(c || o)), (v = G), u !== null)) {
        const ce = u.views;
        m !== null &&
          (e.setRenderTargetFramebuffer(h, m.framebuffer),
          e.setRenderTarget(h));
        let he = !1;
        ce.length !== w.cameras.length && ((w.cameras.length = 0), (he = !0));
        for (let fe = 0; fe < ce.length; fe++) {
          const ye = ce[fe];
          let Be = null;
          if (m !== null) Be = m.getViewport(ye);
          else {
            const Re = d.getViewSubImage(f, ye);
            (Be = Re.viewport),
              fe === 0 &&
                (e.setRenderTargetTextures(
                  h,
                  Re.colorTexture,
                  f.ignoreDepthValues ? void 0 : Re.depthStencilTexture
                ),
                e.setRenderTarget(h));
          }
          let Te = C[fe];
          Te === void 0 &&
            ...
            (Te.viewport = new Ke()),
            (C[fe] = Te)),
            Te.matrix.fromArray(ye.transform.matrix),
            Te.matrix.decompose(Te.position, Te.quaternion, Te.scale),
            Te.projectionMatrix.fromArray(ye.projectionMatrix),
      ...
      for (let ce = 0; ce < E.length; ce++) {
        const he = S[ce],
          fe = E[ce];
        he !== null && fe !== void 0 && fe.update(he, G, c || o);
      }
      ie && ie(U, G),
        G.detectedPlanes &&
    ...
    (p.ior.value = h.ior),
      ...
      h.clearcoat > 0 &&
        ...
        h.clearcoatNormalMap &&
          ...
          h.side === St && p.clearcoatNormalScale.value.negate())),
      h.iridescence > 0 &&
...
function zp(i, e, t, n) {
  ...
  function c(E, S) {
    let T = r[E.id];
    T === void 0 &&
      (v(E), (T = u(E)), (r[E.id] = T), E.addEventListener("dispose", p));
    const A = S.program;
    n.updateUBOMapping(E, A);
    const C = e.render.frame;
    s[E.id] !== C && (f(E), (s[E.id] = C));
  }
  function u(E) {
    const S = d();
    ...
    return (
      ...
      i.bufferData(i.UNIFORM_BUFFER, A, C),
    ...
    for (let C = 0, w = T.length; C < w; C++) {
      ...
      if (m(V, C, A) === !0) {
        ...
        for (let X = 0; X < b.length; X++) {
          ...
          typeof K == "number"
            ? ((V.__data[0] = K),
              i.bufferSubData(i.UNIFORM_BUFFER, M + W, V.__data))
            : K.isMatrix3
            ? ((V.__data[0] = K.elements[0]),
              (V.__data[1] = K.elements[1]),
              (V.__data[2] = K.elements[2]),
              (V.__data[3] = K.elements[0]),
              (V.__data[4] = K.elements[3]),
              (V.__data[5] = K.elements[4]),
              (V.__data[6] = K.elements[5]),
              (V.__data[7] = K.elements[0]),
              (V.__data[8] = K.elements[6]),
              (V.__data[9] = K.elements[7]),
              (V.__data[10] = K.elements[8]),
              (V.__data[11] = K.elements[0]))
            : (K.toArray(V.__data, W),
              (W += P.storage / Float32Array.BYTES_PER_ELEMENT));
        }
  ...
  function m(E, S, T) {
    const A = E.value;
    if (T[S] === void 0) {
      if (typeof A == "number") T[S] = A;
      else {
        const C = Array.isArray(A) ? A : [A],
          w = [];
        for (let V = 0; V < C.length; V++) w.push(C[V].clone());
        T[S] = w;
      }
      return !0;
    } else if (typeof A == "number") {
      if (T[S] !== A) return (T[S] = A), !0;
    } else {
      const C = Array.isArray(T[S]) ? T[S] : [T[S]],
        w = Array.isArray(A) ? A : [A];
      for (let V = 0; V < C.length; V++) {
        const M = C[V];
        if (M.equals(w[V]) === !1) return M.copy(w[V]), !0;
      }
    }
    return !1;
  }
  function v(E) {
    ...
    for (let w = 0, V = S.length; w < V; w++) {
      ...
      if (
        ...
        C = T % A;
        const X = A - C;
        C !== 0 && X - b.boundary < 0 && ((T += A - C), (M.__offset = T));
      }
      T += b.storage;
    }
    return (
      (C = T % A), C > 0 && (T += A - C), (E.__size = T), (E.__cache = {}), this
    );
  }
  function _(E) {
...
class Qo {
  constructor(e = {}) {
    ...
    try {
      ...
      if (
        ("setAttribute" in t &&
          t.setAttribute("data-engine", `three.js r${Es}`),
        t.addEventListener("webglcontextlost", ze, !1),
        t.addEventListener("webglcontextrestored", L, !1),
        t.addEventListener("webglcontextcreationerror", ae, !1),
        N === null)
      ) {
        const I = ["webgl2", "webgl", "experimental-webgl"];
        if (
          (S.isWebGL1Renderer === !0 && I.shift(), (N = ht(I, x)), N === null)
        )
          throw ht(I)
            ? new Error(
    ...
    function pe() {
      (xe = new $d(N)),
        ...
        (je = new Zd(N)),
        (De = new _p()),
        (Le = new Dp(N, xe, Ae, De, be, Se, je)),
        (Ve = new Wd(S)),
        (Qe = new qd(S)),
        (at = new oh(N, be)),
        (ge = new Hd(N, xe, at, be)),
        (y = new jd(N, at, je, ge)),
        (g = new tf(N, y, at, je)),
        (R = new ef(N, be, Le)),
        (me = new kd(De)),
        (F = new gp(S, Ve, Qe, xe, be, ge, me)),
        (ee = new Bp(S, De)),
        (J = new xp()),
        (te = new bp(xe, be)),
        (le = new zd(S, Ve, Qe, Ae, g, f, l)),
        (se = new Lp(S, g, be)),
        (Me = new zp(N, je, be, Ae)),
        (re = new Gd(N, xe, je, be)),
        ($ = new Kd(N, xe, je, be)),
        (je.programs = F.programs),
        (S.capabilities = be),
        (S.extensions = xe),
        (S.properties = De),
        (S.renderLists = J),
    ...
    (this.xr = de),
      ...
      (this.setPixelRatio = function (x) {
        x !== void 0 && ((Y = x), this.setSize(z, q, !1));
      }),
      ...
      (this.setSize = function (x, I, O = !0) {
        ...
        (z = x),
          ...
          (t.height = Math.floor(I * Y)),
          O === !0 && ((t.style.width = x + "px"), (t.style.height = I + "px")),
          this.setViewport(0, 0, x, I);
      }),
      (this.getDrawingBufferSize = function (x) {
        return x.set(z * Y, q * Y).floor();
      }),
      (this.setDrawingBufferSize = function (x, I, O) {
        (z = x),
          (q = I),
          (Y = O),
          (t.width = Math.floor(x * O)),
          (t.height = Math.floor(I * O)),
          this.setViewport(0, 0, x, I);
      }),
      ...
      (this.setViewport = function (x, I, O, B) {
        x.isVector4 ? j.set(x.x, x.y, x.z, x.w) : j.set(x, I, O, B),
          Ae.viewport(b.copy(j).multiplyScalar(Y).floor());
      }),
      (this.getScissor = function (x) {
        return x.copy(U);
      }),
      (this.setScissor = function (x, I, O, B) {
        x.isVector4 ? U.set(x.x, x.y, x.z, x.w) : U.set(x, I, O, B),
          Ae.scissor(W.copy(U).multiplyScalar(Y).floor());
      }),
      (this.getScissorTest = function () {
        return G;
      }),
      (this.setScissorTest = function (x) {
        Ae.setScissorTest((G = x));
      }),
          ...
          if (H) {
            ...
            _e
              ...
              : ((v[0] = Fe),
                ...
                (v[2] = Ue),
                (v[3] = we),
                N.clearBufferiv(N.COLOR, 0, v));
          } else B |= N.COLOR_BUFFER_BIT;
        }
        I && (B |= N.DEPTH_BUFFER_BIT),
          O &&
      ...
      (this.dispose = function () {
        t.removeEventListener("webglcontextlost", ze, !1),
          ...
          t.removeEventListener("webglcontextcreationerror", ae, !1),
          J.dispose(),
          te.dispose(),
          De.dispose(),
          Ve.dispose(),
          ...
          F.dispose(),
          de.dispose(),
          de.removeEventListener("sessionstart", Ct),
          de.removeEventListener("sessionend", Ye),
    ...
    function Q(x) {
      const I = x.target;
      I.removeEventListener("dispose", Q), k(I);
    }
    function k(x) {
      ne(x), De.remove(x);
    }
    function ne(x) {
      const I = De.get(x).programs;
      I !== void 0 &&
    ...
    this.renderBufferDirect = function (x, I, O, B, H, ue) {
      I === null && (I = qe);
      ...
      let we = O.index,
        Fe = 1;
      if (B.wireframe === !0) {
        if (((we = y.getWireframeAttribute(O)), we === void 0)) return;
        Fe = 2;
      }
      const Pe = O.drawRange,
        Ue = O.attributes.position;
      let Je = Pe.start * Fe,
        yt = (Pe.start + Pe.count) * Fe;
      ue !== null &&
        ((Je = Math.max(Je, ue.start * Fe)),
        (yt = Math.min(yt, (ue.start + ue.count) * Fe))),
        we !== null
          ? ((Je = Math.max(Je, 0)), (yt = Math.min(yt, we.count)))
          : Ue != null &&
            ((Je = Math.max(Je, 0)), (yt = Math.min(yt, Ue.count)));
      const ot = yt - Je;
      if (ot < 0 || ot === 1 / 0) return;
      ge.setup(H, B, Ee, O, we);
      let Yt,
        Ze = re;
      if (
        (we !== null && ((Yt = at.get(we)), (Ze = $), Ze.setIndex(Yt)),
        H.isMesh)
      )
        B.wireframe === !0
          ? (Ae.setLineWidth(B.wireframeLinewidth * Ie()), Ze.setMode(N.LINES))
          : Ze.setMode(N.TRIANGLES);
      else if (H.isLine) {
        let Ge = B.linewidth;
        Ge === void 0 && (Ge = 1),
          Ae.setLineWidth(Ge * Ie()),
          H.isLineSegments
            ? Ze.setMode(N.LINES)
            : H.isLineLoop
            ? Ze.setMode(N.LINE_LOOP)
            : Ze.setMode(N.LINE_STRIP);
      } else
        H.isPoints
          ? Ze.setMode(N.POINTS)
          : H.isSprite && Ze.setMode(N.TRIANGLES);
      if (H.isInstancedMesh) Ze.renderInstances(Je, ot, H.count);
      else if (O.isInstancedBufferGeometry) {
        const Ge = O._maxInstanceCount !== void 0 ? O._maxInstanceCount : 1 / 0,
          Lr = Math.min(O.instanceCount, Ge);
        Ze.renderInstances(Je, ot, Lr);
      } else Ze.render(Je, ot);
    };
    function ve(x, I, O) {
      x.transparent === !0 && x.side === Qt && x.forceSinglePass === !1
        ? ((x.side = St),
          (x.needsUpdate = !0),
          Hi(x, I, O),
          (x.side = vn),
    ...
    (this.compile = function (x, I, O = null) {
      O === null && (O = x),
        ...
        p.init(),
        E.push(p),
        O.traverseVisible(function (H) {
          H.isLight &&
            H.layers.test(I.layers) &&
            (p.pushLight(H), H.castShadow && p.pushShadow(H));
        }),
        x !== O &&
          x.traverseVisible(function (H) {
            H.isLight &&
              H.layers.test(I.layers) &&
              (p.pushLight(H), H.castShadow && p.pushShadow(H));
          }),
    ...
    const mt = new qo();
    mt.setAnimationLoop(et),
      typeof self < "u" && mt.setContext(self),
      (this.setAnimationLoop = function (x) {
        (He = x), de.setAnimationLoop(x), x === null ? mt.stop() : mt.start();
      }),
      de.addEventListener("sessionstart", Ct),
      de.addEventListener("sessionend", Ye),
      (this.render = function (x, I) {
        ...
        x.matrixWorldAutoUpdate === !0 && x.updateMatrixWorld(),
          ...
          de.enabled === !0 &&
            de.isPresenting === !0 &&
            (de.cameraAutoUpdate === !0 && de.updateCamera(I),
            (I = de.getCamera())),
          x.isScene === !0 && x.onBeforeRender(S, x, I, w),
          (p = te.get(x, E.length)),
          p.init(),
          E.push(p),
          Be.multiplyMatrices(I.projectionMatrix, I.matrixWorldInverse),
          ...
          _.init(),
          h.push(_),
          Gt(x, I, 0, S.sortObjects),
          _.finish(),
          S.sortObjects === !0 && _.sort(ie, Z),
        ...
        if (
          ...
          const B = I.cameras;
          for (let H = 0, ue = B.length; H < ue; H++) {
            const _e = B[H];
            zs(_, x, _e, _e.viewport);
          }
        } else zs(_, x, I);
        w !== null &&
          (Le.updateMultisampleRenderTarget(w), Le.updateRenderTargetMipmap(w)),
          x.isScene === !0 && x.onAfterRender(S, x, I),
      ...
      if (x.layers.test(I.layers)) {
        if (x.isGroup) O = x.renderOrder;
          ...
          if (!x.frustumCulled || ce.intersectsSprite(x)) {
            B && Re.setFromMatrixPosition(x.matrixWorld).applyMatrix4(Be);
            const _e = g.update(x),
              Ee = x.material;
            Ee.visible && _.push(x, _e, Ee, O, Re.z, null);
          }
        } else if (
          (x.isMesh || x.isLine || x.isPoints) &&
          (!x.frustumCulled || ce.intersectsObject(x))
        ) {
          const _e = g.update(x),
            Ee = x.material;
          if (
            (B &&
              (x.boundingSphere !== void 0
                ? (x.boundingSphere === null && x.computeBoundingSphere(),
                  Re.copy(x.boundingSphere.center))
                : (_e.boundingSphere === null && _e.computeBoundingSphere(),
                  Re.copy(_e.boundingSphere.center)),
              Re.applyMatrix4(x.matrixWorld).applyMatrix4(Be)),
            Array.isArray(Ee))
          ) {
            const we = _e.groups;
            for (let Fe = 0, Pe = we.length; Fe < Pe; Fe++) {
              const Ue = we[Fe],
                Je = Ee[Ue.materialIndex];
              Je && Je.visible && _.push(x, _e, Je, O, Re.z, Ue);
            }
          } else Ee.visible && _.push(x, _e, Ee, O, Re.z, null);
        }
      }
      const ue = x.children;
      for (let _e = 0, Ee = ue.length; _e < Ee; _e++) Gt(ue[_e], I, O, B);
    }
    function zs(x, I, O, B) {
      const H = x.opaque,
        ue = x.transmissive,
        _e = x.transparent;
      p.setupLightsView(O),
        he === !0 && me.setGlobalState(S.clippingPlanes, O),
        ue.length > 0 && _l(H, ue, I, O),
        B && Ae.viewport(b.copy(B)),
        H.length > 0 && zi(H, I, O),
        ue.length > 0 && zi(ue, I, O),
        _e.length > 0 && zi(_e, I, O),
    ...
    function _l(x, I, O, B) {
      ...
      ye === null &&
        (ye = new Un(1, 1, {
          generateMipmaps: !0,
          type: xe.has("EXT_color_buffer_half_float") ? wi : pn,
          minFilter: Ai,
          samples: ue ? 4 : 0,
        })),
        S.getDrawingBufferSize(Te),
        ue ? ye.setSize(Te.x, Te.y) : ye.setSize(gr(Te.x), gr(Te.y));
      const _e = S.getRenderTarget();
      S.setRenderTarget(ye),
        S.getClearColor(K),
        (P = S.getClearAlpha()),
        P < 1 && S.setClearColor(16777215, 0.5),
        S.clear();
      const Ee = S.toneMapping;
      (S.toneMapping = fn),
        zi(x, O, B),
      ...
      for (let Fe = 0, Pe = I.length; Fe < Pe; Fe++) {
        const Ue = I[Fe],
          ...
          ot = Ue.material,
          Yt = Ue.group;
        if (ot.side === Qt && Je.layers.test(B.layers)) {
          const Ze = ot.side;
          (ot.side = St),
            (ot.needsUpdate = !0),
            Hs(Je, O, B, yt, ot, Yt),
      ...
      we === !0 &&
        (Le.updateMultisampleRenderTarget(ye), Le.updateRenderTargetMipmap(ye)),
        S.setRenderTarget(_e),
        S.setClearColor(K, P),
        (S.toneMapping = Ee);
    }
    function zi(x, I, O) {
      const B = I.isScene === !0 ? I.overrideMaterial : null;
      for (let H = 0, ue = x.length; H < ue; H++) {
        const _e = x[H],
          Ee = _e.object,
          we = _e.geometry,
          Fe = B === null ? _e.material : B,
          Pe = _e.group;
        Ee.layers.test(O.layers) && Hs(Ee, I, O, we, Fe, Pe);
      }
    }
    function Hs(x, I, O, B, H, ue) {
      x.onBeforeRender(S, I, O, B, H, ue),
        x.modelViewMatrix.multiplyMatrices(O.matrixWorldInverse, x.matrixWorld),
        x.normalMatrix.getNormalMatrix(x.modelViewMatrix),
        H.onBeforeRender(S, I, O, B, x, ue),
        H.transparent === !0 && H.side === Qt && H.forceSinglePass === !1
          ? ((H.side = St),
            (H.needsUpdate = !0),
            S.renderBufferDirect(O, I, B, H, x, ue),
            (H.side = vn),
            (H.needsUpdate = !0),
            S.renderBufferDirect(O, I, B, H, x, ue),
            (H.side = Qt))
          : S.renderBufferDirect(O, I, B, H, x, ue),
        x.onAfterRender(S, I, O, B, H, ue);
    }
    function Hi(x, I, O) {
      I.isScene !== !0 && (I = qe);
      const B = De.get(x),
        ...
        _e = H.state.version,
        Ee = F.getParameters(x, H.state, ue, I, O),
        we = F.getProgramCacheKey(Ee);
      let Fe = B.programs;
      (B.environment = x.isMeshStandardMaterial ? I.environment : null),
        (B.fog = I.fog),
        (B.envMap = (x.isMeshStandardMaterial ? Qe : Ve).get(
          x.envMap || B.environment
        )),
        Fe === void 0 &&
          (x.addEventListener("dispose", Q),
          (Fe = new Map()),
          (B.programs = Fe));
      let Pe = Fe.get(we);
      if (Pe !== void 0) {
        if (B.currentProgram === Pe && B.lightsStateVersion === _e)
          return Vs(x, Ee), Pe;
      } else
        (Ee.uniforms = F.getUniforms(x)),
          x.onBuild(O, Ee, S),
          x.onBeforeCompile(Ee, S),
          (Pe = F.acquireProgram(Ee, we)),
          Fe.set(we, Pe),
          (B.uniforms = Ee.uniforms);
      const Ue = B.uniforms;
      return (
        ...
        B.needsLights &&
          ((Ue.ambientLightColor.value = H.state.ambient),
          (Ue.lightProbe.value = H.state.probe),
          (Ue.directionalLights.value = H.state.directional),
          (Ue.directionalLightShadows.value = H.state.directionalShadow),
          (Ue.spotLights.value = H.state.spot),
          (Ue.spotLightShadows.value = H.state.spotShadow),
          (Ue.rectAreaLights.value = H.state.rectArea),
          (Ue.ltc_1.value = H.state.rectAreaLTC1),
          (Ue.ltc_2.value = H.state.rectAreaLTC2),
          (Ue.pointLights.value = H.state.point),
          (Ue.pointLightShadows.value = H.state.pointShadow),
          (Ue.hemisphereLights.value = H.state.hemi),
          (Ue.directionalShadowMap.value = H.state.directionalShadowMap),
          (Ue.directionalShadowMatrix.value = H.state.directionalShadowMatrix),
          (Ue.spotShadowMap.value = H.state.spotShadowMap),
          (Ue.spotLightMatrix.value = H.state.spotLightMatrix),
          (Ue.spotLightMap.value = H.state.spotLightMap),
          (Ue.pointShadowMap.value = H.state.pointShadowMap),
          (Ue.pointShadowMatrix.value = H.state.pointShadowMatrix)),
        (B.currentProgram = Pe),
        (B.uniformsList = null),
        Pe
      );
    ...
    function Gs(x) {
      if (x.uniformsList === null) {
        ...
        x.uniformsList = hr.seqWithValue(I.seq, x.uniforms);
      }
      return x.uniformsList;
    }
    function Vs(x, I) {
      const O = De.get(x);
      (O.outputColorSpace = I.outputColorSpace),
        (O.instancing = I.instancing),
        (O.instancingColor = I.instancingColor),
    ...
    function vl(x, I, O, B, H) {
      I.isScene !== !0 && (I = qe), Le.resetTextureUnits();
      const ue = I.fog,
        _e = B.isMeshStandardMaterial ? I.environment : null,
        Ee =
          w === null
            ? S.outputColorSpace
            ...
            : tn,
        we = (B.isMeshStandardMaterial ? Qe : Ve).get(B.envMap || _e),
        Fe =
          B.vertexColors === !0 &&
          !!O.attributes.color &&
          O.attributes.color.itemSize === 4,
        Pe = !!O.attributes.tangent && (!!B.normalMap || B.anisotropy > 0),
        Ue = !!O.morphAttributes.position,
        Je = !!O.morphAttributes.normal,
      ...
      let tt = !1;
      B.version === Ge.__version
        ? ((Ge.needsLights && Ge.lightsStateVersion !== Lr.state.version) ||
            Ge.outputColorSpace !== Ee ||
            (H.isInstancedMesh && Ge.instancing === !1) ||
            (!H.isInstancedMesh && Ge.instancing === !0) ||
            (H.isSkinnedMesh && Ge.skinning === !1) ||
            (!H.isSkinnedMesh && Ge.skinning === !0) ||
            (H.isInstancedMesh &&
              Ge.instancingColor === !0 &&
              H.instanceColor === null) ||
            (H.isInstancedMesh &&
            ...
            Ge.vertexAlphas !== Fe ||
            Ge.vertexTangents !== Pe ||
            Ge.morphTargets !== Ue ||
            Ge.morphNormals !== Je ||
            Ge.morphColors !== yt ||
            Ge.toneMapping !== ot ||
            (be.isWebGL2 === !0 && Ge.morphTargetsCount !== Ze)) &&
          (tt = !0)
        : ((tt = !0), (Ge.__version = B.version));
      ...
      const gt = Sn.getUniforms(),
        En = Ge.uniforms;
      if (
        (Ae.useProgram(Sn.program) && ((ks = !0), (gi = !0), (Pr = !0)),
        B.id !== V && ((V = B.id), (gi = !0)),
        ks || M !== x)
      ) {
        gt.setValue(N, "projectionMatrix", x.projectionMatrix),
          gt.setValue(N, "viewMatrix", x.matrixWorldInverse);
        const Tt = gt.map.cameraPosition;
        Tt !== void 0 &&
          Tt.setValue(N, Re.setFromMatrixPosition(x.matrixWorld)),
          ...
          (B.isMeshPhongMaterial ||
            ...
            B.isShaderMaterial) &&
            gt.setValue(N, "isOrthographic", x.isOrthographicCamera === !0),
          M !== x && ((M = x), (gi = !0), (Pr = !0));
      }
      if (H.isSkinnedMesh) {
        gt.setOptional(N, H, "bindMatrix"),
          gt.setOptional(N, H, "bindMatrixInverse");
        const Tt = H.skeleton;
        Tt &&
          (be.floatVertexTextures
            ? (Tt.boneTexture === null && Tt.computeBoneTexture(),
              gt.setValue(N, "boneTexture", Tt.boneTexture, Le),
              gt.setValue(N, "boneTextureSize", Tt.boneTextureSize))
            : console.warn(
                "THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."
              ));
      }
      const Dr = O.morphAttributes;
      if (
        ((Dr.position !== void 0 ||
          Dr.normal !== void 0 ||
          (Dr.color !== void 0 && be.isWebGL2 === !0)) &&
          R.update(H, O, Sn),
        (gi || Ge.receiveShadow !== H.receiveShadow) &&
          ((Ge.receiveShadow = H.receiveShadow),
          gt.setValue(N, "receiveShadow", H.receiveShadow)),
        ...
        gi &&
          (gt.setValue(N, "toneMappingExposure", S.toneMappingExposure),
          Ge.needsLights && xl(En, Pr),
          ue && B.fog === !0 && ee.refreshFogUniforms(En, ue),
          ee.refreshMaterialUniforms(En, B, Y, q, ye),
          hr.upload(N, Gs(Ge), En, Le)),
        B.isShaderMaterial &&
          B.uniformsNeedUpdate === !0 &&
          (hr.upload(N, Gs(Ge), En, Le), (B.uniformsNeedUpdate = !1)),
        B.isSpriteMaterial && gt.setValue(N, "center", H.center),
        gt.setValue(N, "modelViewMatrix", H.modelViewMatrix),
        gt.setValue(N, "normalMatrix", H.normalMatrix),
        gt.setValue(N, "modelMatrix", H.matrixWorld),
        B.isShaderMaterial || B.isRawShaderMaterial)
      ) {
        const Tt = B.uniformsGroups;
        for (let Ur = 0, Sl = Tt.length; Ur < Sl; Ur++)
          if (be.isWebGL2) {
            const Ws = Tt[Ur];
            Me.update(Ws, Sn), Me.bind(Ws, Sn);
          } else
            console.warn(
    ...
    (this.getActiveCubeFace = function () {
      ...
      (this.setRenderTargetTextures = function (x, I, O) {
        (De.get(x.texture).__webglTexture = I),
          (De.get(x.depthTexture).__webglTexture = O);
        const B = De.get(x);
      ...
      (this.setRenderTarget = function (x, I = 0, O = 0) {
        ...
        if (x) {
          ...
          we.__useDefaultFramebuffer !== void 0
            ? (Ae.bindFramebuffer(N.FRAMEBUFFER, null), (B = !1))
            : we.__webglFramebuffer === void 0
            ? Le.setupRenderTarget(x)
            : we.__hasExternalTextures &&
              Le.rebindTextures(
                x,
                De.get(x.texture).__webglTexture,
                De.get(x.depthTexture).__webglTexture
              );
          const Fe = x.texture;
          (Fe.isData3DTexture ||
            ...
            (_e = !0);
          const Pe = De.get(x).__webglFramebuffer;
          x.isWebGLCubeRenderTarget
            ? (Array.isArray(Pe[I]) ? (H = Pe[I][O]) : (H = Pe[I]), (ue = !0))
            : be.isWebGL2 && x.samples > 0 && Le.useMultisampledRTT(x) === !1
            ? (H = De.get(x).__webglMultisampledFramebuffer)
            : Array.isArray(Pe)
            ? (H = Pe[O])
            : (H = Pe),
            b.copy(x.viewport),
          ...
          b.copy(j).multiplyScalar(Y).floor(),
            W.copy(U).multiplyScalar(Y).floor(),
            (X = G);
        if (
          (Ae.bindFramebuffer(N.FRAMEBUFFER, H) &&
            be.drawBuffers &&
            B &&
            Ae.drawBuffers(x, H),
          Ae.viewport(b),
          ...
          const we = De.get(x.texture);
          N.framebufferTexture2D(
            N.FRAMEBUFFER,
            N.COLOR_ATTACHMENT0,
            N.TEXTURE_CUBE_MAP_POSITIVE_X + I,
            we.__webglTexture,
            O
          );
        } else if (_e) {
      ...
      (this.readRenderTargetPixels = function (x, I, O, B, H, ue, _e) {
        ...
        let Ee = De.get(x).__webglFramebuffer;
        if ((x.isWebGLCubeRenderTarget && _e !== void 0 && (Ee = Ee[_e]), Ee)) {
          ...
          try {
            ...
            const Ue =
              ...
              (xe.has("EXT_color_buffer_half_float") ||
                (be.isWebGL2 && xe.has("EXT_color_buffer_float")));
            if (
              Pe !== pn &&
              Se.convert(Pe) !==
            ...
            I >= 0 &&
              ...
              O >= 0 &&
              O <= x.height - H &&
              N.readPixels(I, O, B, H, Se.convert(Fe), Se.convert(Pe), ue);
          } finally {
            const we = w !== null ? De.get(w).__webglFramebuffer : null;
      ...
      (this.copyFramebufferToTexture = function (x, I, O = 0) {
        const B = Math.pow(2, -O),
          H = Math.floor(I.image.width * B),
          ue = Math.floor(I.image.height * B);
        Le.setTexture2D(I, 0),
          N.copyTexSubImage2D(N.TEXTURE_2D, O, 0, 0, x.x, x.y, H, ue),
          Ae.unbindTexture();
      }),
      (this.copyTextureToTexture = function (x, I, O, B = 0) {
        const H = I.image.width,
          ue = I.image.height,
          _e = Se.convert(O.format),
          Ee = Se.convert(O.type);
        Le.setTexture2D(O, 0),
          ...
          I.isDataTexture
            ...
            : N.texSubImage2D(N.TEXTURE_2D, B, x.x, x.y, _e, Ee, I.image),
          B === 0 && O.generateMipmaps && N.generateMipmap(N.TEXTURE_2D),
          Ae.unbindTexture();
      }),
      (this.copyTextureToTexture3D = function (x, I, O, B, H = 0) {
        ...
        const ue = x.max.x - x.min.x + 1,
          _e = x.max.y - x.min.y + 1,
          Ee = x.max.z - x.min.z + 1,
          we = Se.convert(B.format),
          Fe = Se.convert(B.type);
        let Pe;
        if (B.isData3DTexture) Le.setTexture3D(B, 0), (Pe = N.TEXTURE_3D);
        else if (B.isDataArrayTexture)
          Le.setTexture2DArray(B, 0), (Pe = N.TEXTURE_2D_ARRAY);
        else {
          console.warn(
        ...
        const Ue = N.getParameter(N.UNPACK_ROW_LENGTH),
          Je = N.getParameter(N.UNPACK_IMAGE_HEIGHT),
          yt = N.getParameter(N.UNPACK_SKIP_PIXELS),
          ot = N.getParameter(N.UNPACK_SKIP_ROWS),
          Yt = N.getParameter(N.UNPACK_SKIP_IMAGES),
          Ze = O.isCompressedTexture ? O.mipmaps[0] : O.image;
        N.pixelStorei(N.UNPACK_ROW_LENGTH, Ze.width),
          N.pixelStorei(N.UNPACK_IMAGE_HEIGHT, Ze.height),
          N.pixelStorei(N.UNPACK_SKIP_PIXELS, x.min.x),
          N.pixelStorei(N.UNPACK_SKIP_ROWS, x.min.y),
          N.pixelStorei(N.UNPACK_SKIP_IMAGES, x.min.z),
          O.isDataTexture || O.isData3DTexture
            ? N.texSubImage3D(Pe, H, I.x, I.y, I.z, ue, _e, Ee, we, Fe, Ze.data)
            ...
            : N.texSubImage3D(Pe, H, I.x, I.y, I.z, ue, _e, Ee, we, Fe, Ze),
          N.pixelStorei(N.UNPACK_ROW_LENGTH, Ue),
          N.pixelStorei(N.UNPACK_IMAGE_HEIGHT, Je),
          N.pixelStorei(N.UNPACK_SKIP_PIXELS, yt),
          N.pixelStorei(N.UNPACK_SKIP_ROWS, ot),
          N.pixelStorei(N.UNPACK_SKIP_IMAGES, Yt),
          H === 0 && B.generateMipmaps && N.generateMipmap(Pe),
          Ae.unbindTexture();
      }),
      (this.initTexture = function (x) {
        x.isCubeTexture
          ? Le.setTextureCube(x, 0)
          : x.isData3DTexture
          ? Le.setTexture3D(x, 0)
          : x.isDataArrayTexture || x.isCompressedArrayTexture
          ? Le.setTexture2DArray(x, 0)
          : Le.setTexture2D(x, 0),
          Ae.unbindTexture();
      }),
      (this.resetState = function () {
        (A = 0), (C = 0), (w = null), Ae.reset(), ge.reset();
      }),
  ...
  set outputColorSpace(e) {
    ...
    (t.drawingBufferColorSpace = e === Ts ? "display-p3" : "srgb"),
      (t.unpackColorSpace =
        Xe.workingColorSpace === vr ? "display-p3" : "srgb");
  }
  ...
  get outputEncoding() {
    return (
      ...
      this.outputColorSpace === We ? Dn : Do
    );
  }
  set outputEncoding(e) {
    console.warn(
      ...
      (this.outputColorSpace = e === Dn ? We : tn);
  }
  get useLegacyLights() {
    return (
      console.warn(
...
class Hp extends Qo {}
Hp.prototype.isWebGL1Renderer = !0;
class Cs {
  ...
  constructor(
    ...
    function S(T) {
      ...
      const M = T === !0 ? e : t,
        b = T === !0 ? 1 : -1;
      for (let X = 1; X <= r; X++)
        d.push(0, p * b, 0), f.push(0, b, 0), m.push(0.5, 0.5), v++;
      const W = v;
      for (let X = 0; X <= r; X++) {
        const P = (X / r) * l + a,
          z = Math.cos(P),
      ...
      for (let X = 0; X < r; X++) {
        const K = A + X,
          P = W + X;
        T === !0 ? u.push(P, P + 1, K) : u.push(P + 1, P, K), (V += 3);
      }
      c.addGroup(h, V, T === !0 ? 1 : 2), (h += V);
    }
  }
  copy(e) {
    return (
...
Us.DEFAULT_MATERIAL_NAME = "__DEFAULT";
class Wp extends Us {
  constructor(e) {
    super(e);
  }
  load(e, t, n, r) {
    ...
    const a = Ci("img");
    function l() {
      u(), uo.add(e, this), t && t(this), s.manager.itemEnd(e);
    }
    function c(d) {
...
class el {
  ...
  updateMatrices(e) {
    ...
    fo.setFromMatrixPosition(e.matrixWorld),
      ...
      this._frustum.setFromProjectionMatrix(cs),
...
class Yp extends el {
  ...
  updateMatrices(e, t = 0) {
    ...
    s !== n.far && ((n.far = s), n.updateProjectionMatrix()),
      ...
      n.lookAt(hs),
      n.updateMatrixWorld(),
      r.makeTranslation(-Si.x, -Si.y, -Si.z),
...
class qp extends el {
  constructor() {
    super(new $o(-5, 5, 5, -5, 0.5, 500)), (this.isDirectionalLightShadow = !0);
  }
}
class $p extends Is {
  constructor(e, t) {
...
typeof __THREE_DEVTOOLS__ < "u" &&
  __THREE_DEVTOOLS__.dispatchEvent(
    new CustomEvent("register", { detail: { revision: Es } })
  );
typeof window < "u" &&
  (window.__THREE__
    ? console.warn("WARNING: Multiple instances of Three.js being imported.")
    : (window.__THREE__ = Es));
const vo = { type: "change" },
  us = { type: "start" },
  xo = { type: "end" },
  cr = new Bo(),
  Mo = new cn(),
  Zp = Math.cos(70 * Nc.DEG2RAD);
class Jp extends Fn {
  constructor(e, t) {
    super(),
      (this.object = e),
      ...
      (this.touches = { ONE: Hn.ROTATE, TWO: Hn.DOLLY_PAN }),
      ...
      (this.update = (function () {
        const R = new D(),
          re = new In().setFromUnitVectors(e.up, new D(0, 1, 0)),
          $ = re.clone().invert(),
          Se = new D(),
          ge = new In(),
          Me = new D(),
        ...
        return function (ze = null) {
          ...
          R.copy(L).sub(n.target),
            R.applyQuaternion(re),
            a.setFromVector3(R),
            n.autoRotate && s === r.NONE && W(M(ze)),
            n.enableDamping
              ? ((a.theta += l.theta * n.dampingFactor),
                (a.phi += l.phi * n.dampingFactor))
              : ((a.theta += l.theta), (a.phi += l.phi));
          let ae = n.minAzimuthAngle,
            Q = n.maxAzimuthAngle;
          isFinite(ae) &&
            isFinite(Q) &&
            (ae < -Math.PI ? (ae += pe) : ae > Math.PI && (ae -= pe),
            Q < -Math.PI ? (Q += pe) : Q > Math.PI && (Q -= pe),
            ae <= Q
              ? (a.theta = Math.max(ae, Math.min(Q, a.theta)))
              : (a.theta =
                  a.theta > (ae + Q) / 2
                    ? Math.max(ae, a.theta)
                    : Math.min(Q, a.theta))),
            ...
            (n.zoomToCursor && C) || n.object.isOrthographicCamera
              ? (a.radius = Z(a.radius))
              : (a.radius = Z(a.radius * c)),
            R.setFromSpherical(a),
            R.applyQuaternion($),
            L.copy(n.target).add(R),
          ...
          if (n.zoomToCursor && C) {
            ...
            if (n.object.isPerspectiveCamera) {
              ...
              ne = Z(ve * c);
              const He = ve - ne;
              n.object.position.addScaledVector(T, He),
                n.object.updateMatrixWorld();
            } else if (n.object.isOrthographicCamera) {
              const ve = new D(A.x, A.y, 0);
              ve.unproject(n.object),
                ...
                n.object.updateProjectionMatrix(),
                (k = !0);
              const He = new D(A.x, A.y, 0);
              He.unproject(n.object),
                n.object.position.sub(He).add(ve),
                n.object.updateMatrixWorld(),
                (ne = R.length());
            } else
              console.warn(
            ...
            ne !== null &&
              (this.screenSpacePanning
                ...
                : (cr.origin.copy(n.object.position),
                  cr.direction
                    .set(0, 0, -1)
                    .transformDirection(n.object.matrix),
                  Math.abs(n.object.up.dot(cr.direction)) < Zp
                    ? e.lookAt(n.target)
                    : (Mo.setFromNormalAndCoplanarPoint(n.object.up, n.target),
                      cr.intersectPlane(Mo, n.target))));
          } else
      ...
      (this.dispose = function () {
        n.domElement.removeEventListener("contextmenu", J),
          ...
          n.domElement.removeEventListener("wheel", y),
    ...
    const K = (function () {
        const R = new D();
        return function ($, Se) {
          R.setFromMatrixColumn(Se, 0), R.multiplyScalar(-$), u.add(R);
        };
      })(),
      P = (function () {
        const R = new D();
        return function ($, Se) {
          n.screenSpacePanning === !0
            ? R.setFromMatrixColumn(Se, 1)
            : (R.setFromMatrixColumn(Se, 0), R.crossVectors(n.object.up, R)),
            R.multiplyScalar($),
            u.add(R);
        };
      })(),
        ...
        return function ($, Se) {
          ...
          if (n.object.isPerspectiveCamera) {
            ...
            (pe *= Math.tan(((n.object.fov / 2) * Math.PI) / 180)),
              K((2 * $ * pe) / ge.clientHeight, n.object.matrix),
              P((2 * Se * pe) / ge.clientHeight, n.object.matrix);
          } else
            n.object.isOrthographicCamera
              ? (K(
    ...
    function ce(R) {
      ...
      W((2 * Math.PI * m.x) / re.clientHeight),
        X((2 * Math.PI * m.y) / re.clientHeight),
        d.copy(f),
        n.update();
    }
    function he(R) {
    ...
    function fe(R) {
      _.set(R.clientX, R.clientY),
        p.subVectors(_, v).multiplyScalar(n.panSpeed),
        z(p.x, p.y),
        v.copy(_),
        n.update();
    }
    function ye(R) {
      ie(R), R.deltaY < 0 ? Y(b()) : R.deltaY > 0 && q(b()), n.update();
    }
    function Be(R) {
      let re = !1;
      switch (R.code) {
    ...
    function xe(R) {
      ...
      p.subVectors(_, v).multiplyScalar(n.panSpeed), z(p.x, p.y), v.copy(_);
    }
    function be(R) {
      const re = le(R),
        $ = R.pageX - re.x,
        ...
        ge = Math.sqrt($ * $ + Se * Se);
      E.set(0, ge),
        S.set(0, Math.pow(E.y / h.y, n.zoomSpeed)),
        q(S.y),
        h.copy(E);
    }
    function Ae(R) {
      n.enableZoom && be(R), n.enablePan && xe(R);
    }
    function je(R) {
      n.enableZoom && be(R), n.enableRotate && ht(R);
    }
    function De(R) {
      n.enabled !== !1 &&
        (w.length === 0 &&
        ...
        te(R),
        R.pointerType === "touch" ? F(R) : Qe(R));
    }
    function Le(R) {
      n.enabled !== !1 && (R.pointerType === "touch" ? ee(R) : at(R));
    }
    function Ve(R) {
      me(R),
        w.length === 0 &&
    ...
    function y(R) {
      n.enabled === !1 ||
        n.enableZoom === !1 ||
        s !== r.NONE ||
        (R.preventDefault(), n.dispatchEvent(us), ye(R), n.dispatchEvent(xo));
    }
    function g(R) {
    ...
    function se(R) {
      let re = V[R.pointerId];
      re === void 0 && ((re = new Ce()), (V[R.pointerId] = re)),
        re.set(R.pageX, R.pageY);
    }
    function le(R) {
    ...
    n.domElement.addEventListener("contextmenu", J),
      ...
      n.domElement.addEventListener("wheel", y, { passive: !1 }),
      this.update();
  }
}
/**
 ...
 */ class Xt {
  constructor(e, t, n, r, s = "div") {
    (this.parent = e),
      ...
      (Xt.nextNameID = Xt.nextNameID || 0),
      (this.$name.id = `lil-gui-name-${++Xt.nextNameID}`),
...
class sm extends Xt {
  constructor(e, t, n, r) {
    super(e, t, n, "color"),
      ...
      (this._format = rm(this.initialValue)),
      (this._rgbScale = r),
...
class am extends Xt {
  ...
  _initInput() {
    ...
    const t = () => {
      ...
      n = (E) => {
        ...
        isNaN(S) ||
          (this._snapClampSetValue(S + E),
          (this.$input.value = this.getValue()));
      },
      r = (E) => {
        E.key === "Enter" && this.$input.blur(),
          E.code === "ArrowUp" &&
            (E.preventDefault(), n(this._step * this._arrowKeyMultiplier(E))),
          E.code === "ArrowDown" &&
            (E.preventDefault(),
            n(this._step * this._arrowKeyMultiplier(E) * -1));
      },
      s = (E) => {
        this._inputFocused &&
          (E.preventDefault(), n(this._step * this._normalizeMouseWheel(E)));
      };
    let o = !1,
      a,
      l,
    ...
    const f = 5,
      ...
      v = (E) => {
        ...
        if (!o) {
          const S = E.clientY - c;
          (d -= S * this._step * this._arrowKeyMultiplier(E)),
            u + d > this._max
              ? (d = this._max - u)
              : u + d < this._min && (d = this._min - u),
            this._snapClampSetValue(u + d);
        }
        c = E.clientY;
      },
      _ = () => {
  ...
  _initSlider() {
    ...
    const e = (h, E, S, T, A) => ((h - E) / (S - E)) * (A - T) + T,
      t = (h) => {
        const E = this.$slider.getBoundingClientRect();
        let S = e(h, E.left, E.right, this._min, this._max);
    ...
    const c = (h) => {
      ...
      u = (h) => {
        h.touches.length > 1 ||
          (this._hasScrollBar
            ? ((a = h.touches[0].clientX), (l = h.touches[0].clientY), (o = !0))
            : c(h),
      ...
      d = (h) => {
        if (o) {
          const E = h.touches[0].clientX - a,
            S = h.touches[0].clientY - l;
    ...
    const p = (h) => {
      ...
      h.preventDefault();
      const S = this._normalizeMouseWheel(h) * this._step;
      this._snapClampSetValue(this.getValue() + S),
        (this.$input.value = this.getValue()),
        clearTimeout(_),
        (_ = setTimeout(m, v));
    };
  ...
  options(e) {
    return (
      ...
      this._names.forEach((t) => {
        ...
        (n.innerHTML = t), this.$select.appendChild(n);
      }),
      this.updateDisplay(),
      this
    );
...
class Ns {
  ...
  add(e, t, n, r, s) {
    if (Object(n) === n) return new om(this, e, t, n);
    const o = e[t];
    switch (typeof o) {
      case "number":
        return new am(this, e, t, n, r, s);
      case "boolean":
        return new Qp(this, e, t);
      case "string":
        return new lm(this, e, t);
      case "function":
        return new ds(this, e, t);
    }
    console.error(
      `gui.add failed
	property:`,
  ...
  addColor(e, t, n = 1) {
    return new sm(this, e, t, n);
  }
  addFolder(e) {
    const t = new Ns({ parent: this, title: e });
...
const um = Ns,
  Ii = new um(),
  tl = document.querySelector("canvas.webgl"),
  Ut = new Gp(),
  dm = new Cs("#262837", 1, 15);
Ut.fog = dm;
const Mt = new Xp(),
  nl = Mt.load("./textures/door/color.jpg");
nl.colorSpace = We;
const il = Mt.load("./textures/door/alpha.jpg");
il.colorSpace = We;
const rl = Mt.load("./textures/door/ambientOcclusion.jpg");
rl.colorSpace = We;
const sl = Mt.load("./textures/door/height.jpg");
sl.colorSpace = We;
const al = Mt.load("./textures/door/normal.jpg");
al.colorSpace = We;
const ol = Mt.load("./textures/door/metalness.jpg");
ol.colorSpace = We;
const ll = Mt.load("./textures/door/roughness.jpg");
ll.colorSpace = We;
const cl = Mt.load("./textures/bricks/color.jpg");
cl.colorSpace = We;
const hl = Mt.load("./textures/bricks/ambientOcclusion.jpg");
hl.colorSpace = We;
const ul = Mt.load("./textures/bricks/normal.jpg");
ul.colorSpace = We;
const dl = Mt.load("./textures/bricks/roughness.jpg");
dl.colorSpace = We;
const Ni = Mt.load("./textures/grass/color.jpg");
Ni.colorSpace = We;
const Fi = Mt.load("./textures/grass/ambientOcclusion.jpg");
Fi.colorSpace = We;
const Oi = Mt.load("./textures/grass/normal.jpg");
Oi.colorSpace = We;
const Er = Mt.load("./textures/grass/roughness.jpg");
Ni.repeat.set(8, 8);
Fi.repeat.set(8, 8);
Oi.repeat.set(8, 8);
Er.repeat.set(8, 8);
...
const Fs = new ct(
  new On(4, 2.5, 4),
  new pi({ map: cl, aoMap: hl, normalMap: ul, roughness: dl })
);
Fs.position.y = 2.5 / 2;
Bi.add(Fs);
const Os = new ct(new Ps(3.5, 1, 4), new pi({ color: "#b35f45" }));
Os.position.y = 2.5 + 1 / 2;
Os.rotation.y = Math.PI * 0.25;
Bi.add(Os);
const Bs = new ct(
  new Ui(2.2, 2.2, 100, 100),
  new pi({
    map: nl,
    alphaMap: il,
    transparent: !0,
...
Bi.add(Bs);
Bs.position.z = 4 * 0.5 + 0.01;
Bs.position.y = 1;
const yr = new Ds(1, 16, 16),
  Tr = new pi({ color: "#89c854" }),
  br = new ct(yr, Tr);
br.scale.set(0.5, 0.5, 0.5);
br.position.set(0.8, 0.2, 2.2);
const Ar = new ct(yr, Tr);
Ar.scale.set(0.25, 0.25, 0.25);
Ar.position.set(1.4, 0.1, 2.1);
const wr = new ct(yr, Tr);
wr.scale.set(0.4, 0.4, 0.4);
wr.position.set(-0.8, 0.1, 2.2);
const Rr = new ct(yr, Tr);
Rr.scale.set(0.15, 0.15, 0.15);
Rr.position.set(-1, 0.05, 2.6);
Bi.add(br, Ar, wr, Rr);
const fl = new si();
Ut.add(fl);
const fm = new On(0.6, 0.8, 0.2),
  pm = new pi({ color: "#b2b6b1" });
for (let i = 0; i < 50; i++) {
  const e = new ct(fm, pm);
  fl.add(e);
  const t = Math.random() * Math.PI * 2,
    n = Math.random() * 5 + 5;
  (e.rotation.y = (Math.random() - 0.5) * 0.4),
    (e.rotation.z = (Math.random() - 0.5) * 0.4),
    (e.position.y = 0.3),
    (e.position.x = Math.sin(t) * n),
    (e.position.z = Math.cos(t) * n),
    (e.castShadow = !0);
}
const Cr = new ct(
  new Ui(20, 20),
  new pi({ map: Ni, aoMap: Fi, normal: Oi, roughnessMap: Er })
);
Cr.rotation.x = -Math.PI * 0.5;
Cr.position.y = 0;
Ut.add(Cr);
const pl = new jp("#b9d5ff", 0.12);
Ii.add(pl, "intensity").min(0).max(1).step(0.001);
Ut.add(pl);
const Bn = new $p("#b9d5ff", 0.26);
Bn.position.set(4, 5, -2);
Ii.add(Bn, "intensity").min(0).max(1).step(0.001);
Ii.add(Bn.position, "x").min(-5).max(5).step(0.001);
Ii.add(Bn.position, "y").min(-5).max(5).step(0.001);
Ii.add(Bn.position, "z").min(-5).max(5).step(0.001);
Ut.add(Bn);
const mi = new Sr("#ff7d46", 3, 7);
mi.position.set(0, 2.2, 2.7);
Ut.add(mi);
const mn = new Sr("#ff00ff", 6, 3);
Ut.add(mn);
const gn = new Sr("#00ffff", 6, 3);
Ut.add(gn);
const _n = new Sr("#ffff00", 6, 3);
Ut.add(_n);
const kt = { width: window.innerWidth, height: window.innerHeight };
window.addEventListener("resize", () => {
  (kt.width = window.innerWidth),
    (kt.height = window.innerHeight),
    (xn.aspect = kt.width / kt.height),
    xn.updateProjectionMatrix(),
    Mn.setSize(kt.width, kt.height),
    Mn.setPixelRatio(Math.min(window.devicePixelRatio, 2));
});
const xn = new wt(75, kt.width / kt.height, 0.1, 100);
xn.position.x = 4;
xn.position.y = 2;
xn.position.z = 5;
Ut.add(xn);
const ml = new Jp(xn, tl);
ml.enableDamping = !0;
const Mn = new Qo({ canvas: tl });
Mn.setSize(kt.width, kt.height);
Mn.setPixelRatio(Math.min(window.devicePixelRatio, 2));
Mn.setClearColor("#262837");
Mn.shadowMap.enabled = !0;
Mn.shadowMap.type = yo;
Bn.castShadow = !0;
mi.castShadow = !0;
mn.castShadow = !0;
gn.castShadow = !0;
...
Rr.castShadow = !0;
Cr.receiveShadow = !0;
mi.shadow.mapSize.width = 256;
mi.shadow.mapSize.height = 256;
mi.shadow.camera.far = 7;
mn.shadow.mapSize.width = 256;
mn.shadow.mapSize.height = 256;
mn.shadow.camera.far = 7;
gn.shadow.mapSize.width = 256;
gn.shadow.mapSize.height = 256;
gn.shadow.camera.far = 7;
_n.shadow.mapSize.width = 256;
_n.shadow.mapSize.height = 256;
_n.shadow.camera.far = 7;
const mm = new Kp(),
  gl = () => {
    const i = mm.getElapsedTime(),
      e = i * 0.2;
    (mn.position.x = Math.cos(e) * 4),
      (mn.position.z = Math.sin(e) * 4),
      (mn.position.y = Math.sin(e * 3));
    const t = -i * 0.32;
    (gn.position.x = Math.cos(t) * 5),
      (gn.position.z = Math.sin(t) * 5),
      (gn.position.y = Math.sin(t * 4) + Math.sin(i * 2.5));
    const n = i * 0.18;
    (_n.position.x = Math.cos(n) * (7 + Math.sin(i * 0.32))),
      (_n.position.z = Math.sin(n) * (7 + Math.sin(i * 0.5))),
      (_n.position.y = Math.sin(n * 3) + Math.sin(i * 2)),
      ml.update(),
      Mn.render(Ut, xn),
      window.requestAnimationFrame(gl);
  };
gl();
//# sourceMappingURL=index-e59d6e23.js.map
